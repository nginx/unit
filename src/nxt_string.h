...
NXT_EXPORT void nxt_memcpy_lowcase(u_char* dst,
                                   const u_char* src,
                                   size_t length);
NXT_EXPORT void nxt_memcpy_upcase(u_char* dst,
                                  const u_char* src,
                                  size_t length);
...
NXT_EXPORT nxt_int_t nxt_strncasecmp(const u_char* s1,
                                     const u_char* s2,
                                     size_t length);
NXT_EXPORT nxt_int_t nxt_memcasecmp(const void* p1,
                                    const void* p2,
                                    size_t length);

NXT_EXPORT u_char* nxt_memstrn(const u_char* s,
                               const u_char* end,
                               const char* ss,
                               size_t length);
NXT_EXPORT u_char* nxt_memcasestrn(const u_char* s,
                                   const u_char* end,
                                   const char* ss,
                                   size_t length);
NXT_EXPORT u_char* nxt_rmemstrn(const u_char* s,
                                const u_char* end,
                                const char* ss,
                                size_t length);
...
NXT_EXPORT nxt_str_t* nxt_str_dup(nxt_mp_t* mp,
                                  nxt_str_t* dst,
                                  const nxt_str_t* src);
...
NXT_EXPORT nxt_bool_t nxt_strvers_match(u_char* version,
                                        u_char* prefix,
                                        size_t length);
...
NXT_EXPORT uintptr_t nxt_encode_complex_uri(u_char* dst,
                                            u_char* src,
                                            size_t length);
