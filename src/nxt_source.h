...
typedef void (*nxt_source_handler_t)(void *source_context, nxt_source_hook_t *query);
...
#define nxt_source_filter(thr, wq, task, next, out)                                                                    \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            nxt_thread_work_queue_add(thr, wq, nxt_source_filter_handler, task, next, out);                            \
        }                                                                                                              \
        else                                                                                                           \
        {                                                                                                              \
...
NXT_EXPORT void nxt_source_filter_handler(nxt_task_t *task, void *obj, void *data);
