...
typedef struct {
   ...
   */
  nxt_int_t (*create)(nxt_event_engine_t *engine, nxt_uint_t mchanges,
                      nxt_uint_t mevents);
...
NXT_EXPORT nxt_event_engine_t *nxt_event_engine_create(
    nxt_task_t *task, const nxt_event_interface_t *interface,
    const nxt_sig_event_t *signals, nxt_uint_t flags, nxt_uint_t batch);
NXT_EXPORT nxt_int_t nxt_event_engine_change(
    nxt_event_engine_t *engine, const nxt_event_interface_t *interface,
    nxt_uint_t batch);
