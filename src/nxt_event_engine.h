...
nxt_int_t nxt_fd_event_hash_add(nxt_lvlhsh_t* lvlhsh,
                                nxt_fd_t fd,
                                nxt_fd_event_t* ev);
void* nxt_fd_event_hash_get(nxt_task_t* task,
                            nxt_lvlhsh_t* lvlhsh,
                            nxt_fd_t fd);
void nxt_fd_event_hash_delete(nxt_task_t* task,
                              nxt_lvlhsh_t* lvlhsh,
                              nxt_fd_t fd,
                              nxt_bool_t ignore);
...
NXT_EXPORT nxt_event_engine_t* nxt_event_engine_create(
    nxt_task_t* task,
...
void* nxt_event_engine_mem_alloc(nxt_event_engine_t* engine,
                                 uint8_t* hint,
                                 size_t size);
void nxt_event_engine_mem_free(nxt_event_engine_t* engine,
                               uint8_t hint,
                               void* p,
                               size_t size);
...
void nxt_event_engine_buf_mem_completion(nxt_task_t* task,
                                         void* obj,
                                         void* data);
