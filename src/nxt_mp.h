 ...
 */
NXT_EXPORT void *
nxt_mp_alloc(nxt_mp_t *mp, size_t size) NXT_MALLOC_LIKE;
 ...
 */
NXT_EXPORT void *
nxt_mp_zalloc(nxt_mp_t *mp, size_t size) NXT_MALLOC_LIKE;

/* nxt_mp_align() returns aligned freeable memory. */
NXT_EXPORT void *
nxt_mp_align(nxt_mp_t *mp, size_t alignment, size_t size) NXT_MALLOC_LIKE;

/* nxt_mp_zalign() returns zeroed aligned freeable memory. */
NXT_EXPORT void *
nxt_mp_zalign(nxt_mp_t *mp, size_t alignment, size_t size) NXT_MALLOC_LIKE;
...
NXT_EXPORT void *
nxt_mp_nget(nxt_mp_t *mp, size_t size) NXT_MALLOC_LIKE;
 ...
 */
NXT_EXPORT void *
nxt_mp_get(nxt_mp_t *mp, size_t size) NXT_MALLOC_LIKE;
 ...
 */
NXT_EXPORT void *
nxt_mp_zget(nxt_mp_t *mp, size_t size) NXT_MALLOC_LIKE;
