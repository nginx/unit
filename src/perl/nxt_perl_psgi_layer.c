...
static PerlIO *nxt_perl_psgi_layer_stream_open(pTHX_ PerlIO_funcs *self,
                                               ...
                                               int imode, int perm, PerlIO *f,
                                               int narg, SV **args);

static IV nxt_perl_psgi_layer_stream_close(pTHX_ PerlIO *f);

static SSize_t nxt_perl_psgi_layer_stream_read(pTHX_ PerlIO *f, void *vbuf,
                                               Size_t count);
...
static IV nxt_perl_psgi_layer_stream_seek(pTHX_ PerlIO *f, Off_t offset,
                                          int whence);
...
static SV *nxt_perl_psgi_layer_stream_arg(pTHX_ PerlIO *f, CLONE_PARAMS *param,
                                          int flags);
...
static void nxt_perl_psgi_layer_stream_set_ptrcnt(pTHX_ PerlIO *f, STDCHAR *ptr,
                                                  SSize_t cnt);
...
static IV nxt_perl_psgi_layer_stream_flush(pTHX_ PerlIO *f) { return 0; }
...
static IV nxt_perl_psgi_layer_stream_eof(pTHX_ PerlIO *f) { return 1; }
...
static SSize_t nxt_perl_psgi_layer_stream_get_cnt(pTHX_ PerlIO *f) { return 0; }
...
PerlIO *nxt_perl_psgi_layer_stream_fp_create(pTHX_ SV *arg_rv,
                                             const char *mode) {
  return PerlIO_openn(aTHX_ "NGINX_Unit_PSGI_Layer_Stream", mode, 0, 0, 0, NULL,
                      1, &arg_rv);
}
