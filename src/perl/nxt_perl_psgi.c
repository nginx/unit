...
static SV* nxt_perl_psgi_call_var_application(PerlInterpreter* my_perl,
                                              ...
                                              SV* app,
                                              nxt_unit_request_info_t* req);
static SV* nxt_perl_psgi_call_method(PerlInterpreter* my_perl,
                                     SV* obj,
                                     const char* method,
                                     nxt_unit_request_info_t* req);
...
static SV* nxt_perl_psgi_env_create(PerlInterpreter* my_perl,
                                    nxt_unit_request_info_t* req);
nxt_inline int nxt_perl_psgi_add_sptr(PerlInterpreter* my_perl,
                                      HV* hash_env,
                                      const char* name,
                                      uint32_t name_len,
                                      nxt_unit_sptr_t* sptr,
                                      uint32_t len);
nxt_inline int nxt_perl_psgi_add_str(PerlInterpreter* my_perl,
                                     HV* hash_env,
                                     const char* name,
                                     uint32_t name_len,
                                     const char* str,
                                     uint32_t len);
nxt_inline int nxt_perl_psgi_add_value(PerlInterpreter* my_perl,
                                       HV* hash_env,
                                       const char* name,
                                       uint32_t name_len,
                                       void* value);
...
static int nxt_perl_psgi_result_body_ref(PerlInterpreter* my_perl,
                                         SV* sv_body,
                                         nxt_unit_request_info_t* req);
static int nxt_perl_psgi_result_body_fh(PerlInterpreter* my_perl,
                                        SV* sv_body,
                                        nxt_unit_request_info_t* req);
...
static int nxt_perl_psgi_result_array(PerlInterpreter* my_perl,
                                      SV* result,
                                      nxt_unit_request_info_t* req);
static void nxt_perl_psgi_result_cb(PerlInterpreter* my_perl,
                                    SV* result,
                                    nxt_unit_request_info_t* req);
...
XS(XS_NGINX__Unit__Sandbox_cb) {
  ...
  if (nxt_slow_path(SvOK(ST(0)) == 0 || SvROK(ST(0)) == 0 ||
    ...
    Perl_croak(aTHX_
               "PSGI: An unexpected response was received "
...
#define NL(S) (S), sizeof(S) - 1
  ...
  RC(nxt_perl_psgi_add_value(
      my_perl, hash_env, NL("psgi.url_scheme"),
  ...
  RC(nxt_perl_psgi_add_value(
      my_perl, hash_env, NL("psgi.multithread"),
...
static int nxt_perl_psgi_result_body(PerlInterpreter* my_perl,
  ...
  for (i = 0; i <= av_len(body_array); i++) {
    ...
    if (nxt_slow_path(rc != NXT_UNIT_OK)) {
      nxt_unit_req_error(req,
                         "PSGI: Failed to write content from "
                         "Perl Application");
      return rc;
    }
  }
