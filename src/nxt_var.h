...
typedef nxt_int_t (*nxt_var_handler_t) (nxt_task_t *task, nxt_str_t *str,
                                        void *ctx, void *data);
...
nxt_int_t nxt_var_test (nxt_tstr_state_t *state, nxt_str_t *str,
                        u_char *error);

nxt_int_t nxt_var_interpreter (nxt_task_t *task, nxt_tstr_state_t *state,
                               nxt_var_cache_t *cache, nxt_var_t *var,
