...
void nxt_work_queue_cache_create(nxt_work_queue_cache_t *cache,
                                 size_t chunk_size) {
...
void nxt_work_queue_add(nxt_work_queue_t *wq, nxt_work_handler_t handler,
...
nxt_work_handler_t nxt_work_queue_pop(nxt_work_queue_t *wq, nxt_task_t **task,
                                      void **obj, void **data) {
  nxt_work_t *work;
...
nxt_work_handler_t nxt_locked_work_queue_pop(nxt_locked_work_queue_t *lwq,
                                             nxt_task_t **task, void **obj,
                                             void **data) {
  nxt_work_t *work;
...
void nxt_locked_work_queue_move(nxt_thread_t *thr, nxt_locked_work_queue_t *lwq,
                                nxt_work_queue_t *wq) {
  nxt_work_t *work;
