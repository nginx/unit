...
static VALUE nxt_ruby_stream_io_rewind(VALUE obj) { return Qnil; }
...
static VALUE nxt_ruby_stream_io_flush(VALUE obj) { return Qnil; }

static VALUE nxt_ruby_stream_io_close(VALUE obj) { return Qnil; }
