...
#define nxt_queue_self(link) nxt_queue_sentinel(link)


#define nxt_queue_is_empty(queue) (&(queue)->head == (queue)->head.prev)
...
#define nxt_queue_first(queue) (queue)->head.next


#define nxt_queue_last(queue) (queue)->head.prev


#define nxt_queue_head(queue) (&(queue)->head)


#define nxt_queue_tail(queue) (&(queue)->head)


#define nxt_queue_next(link) (link)->next


#define nxt_queue_prev(link) (link)->prev
...
#define nxt_queue_link_data(lnk, type, link) nxt_container_of(lnk, type, link)


NXT_EXPORT nxt_queue_link_t *
...
#define nxt_queue_each(elt, queue, type, link)                                 \
    do {                                                                       \
        nxt_queue_link_t *_lnk, *_nxt;                                         \
                                                                               \
        for (_lnk = nxt_queue_first(queue); _lnk != nxt_queue_tail(queue);     \
             _lnk = _nxt) {                                                    \
