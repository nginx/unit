...
nxt_inline void nxt_array_init(nxt_array_t *array, nxt_mp_t *mp, size_t size)
{
...
NXT_EXPORT nxt_array_t *nxt_array_create(nxt_mp_t *mp, nxt_uint_t n, size_t size);
...
NXT_EXPORT nxt_array_t *nxt_array_copy(nxt_mp_t *mp, nxt_array_t *dst, nxt_array_t *src);

#define nxt_array_last(array) nxt_pointer_to((array)->elts, (array)->size *((array)->nelts - 1))

#define nxt_array_reset(array) (array)->nelts = 0;

#define nxt_array_is_empty(array) ((array)->nelts == 0)

nxt_inline void *nxt_array_remove_last(nxt_array_t *array)
{
    array->nelts--;
