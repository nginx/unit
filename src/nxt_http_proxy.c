...
static void nxt_http_proxy_server_get(nxt_task_t *task, nxt_upstream_server_t *us);
...
static nxt_http_action_t *nxt_http_proxy(nxt_task_t *task, nxt_http_request_t *r, nxt_http_action_t *action);
...
static void nxt_http_proxy_buf_mem_completion(nxt_task_t *task, void *obj, void *data);
...
static const nxt_http_request_state_t nxt_http_proxy_header_send_state nxt_aligned(64) = {
...
static const nxt_http_request_state_t nxt_http_proxy_header_sent_state nxt_aligned(64) = {
...
static const nxt_http_request_state_t nxt_http_proxy_header_read_state nxt_aligned(64) = {
...
static void nxt_http_proxy_header_read(nxt_task_t *task, void *obj, void *data)
{
    ...
    nxt_list_each(field, peer->fields)
    {
        ...
        nxt_debug(task, "http proxy header: \"%*s: %*s\"", (size_t)field->name_length, field->name,
...
static const nxt_http_request_state_t nxt_http_proxy_read_state nxt_aligned(64) = {
