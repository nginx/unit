...
static void nxt_http_proxy_buf_mem_completion(nxt_task_t* task,
                                              void* obj,
                                              void* data);
...
static void nxt_http_proxy_header_send(nxt_task_t* task,
                                       void* obj,
                                       void* data) {
  nxt_http_peer_t* peer;
  nxt_http_request_t* r;
...
static void nxt_http_proxy_header_sent(nxt_task_t* task,
                                       void* obj,
                                       void* data) {
  nxt_http_peer_t* peer;
  nxt_http_request_t* r;
...
static void nxt_http_proxy_header_read(nxt_task_t* task,
                                       void* obj,
                                       void* data) {
  nxt_http_peer_t* peer;
