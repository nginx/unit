...
static const nxt_http_request_state_t
    nxt_http_proxy_header_send_state nxt_aligned(64) = {
        .ready_handler = nxt_http_proxy_header_send,
        .error_handler = nxt_http_proxy_error,
};

static void nxt_http_proxy_header_send(nxt_task_t *task, void *obj,
                                       void *data) {
  nxt_http_peer_t *peer;
  nxt_http_request_t *r;
...
static const nxt_http_request_state_t
    nxt_http_proxy_header_sent_state nxt_aligned(64) = {
        .ready_handler = nxt_http_proxy_header_sent,
        .error_handler = nxt_http_proxy_error,
};

static void nxt_http_proxy_header_sent(nxt_task_t *task, void *obj,
                                       void *data) {
  nxt_http_peer_t *peer;
  nxt_http_request_t *r;
...
static const nxt_http_request_state_t
    nxt_http_proxy_header_read_state nxt_aligned(64) = {
        .ready_handler = nxt_http_proxy_header_read,
        .error_handler = nxt_http_proxy_error,
};

static void nxt_http_proxy_header_read(nxt_task_t *task, void *obj,
                                       void *data) {
  nxt_http_peer_t *peer;
...
static const nxt_http_request_state_t
    nxt_http_proxy_read_state nxt_aligned(64) = {
