...
nxt_conf_value_t *nxt_conf_json_parse (nxt_mp_t *mp, u_char *start,
                                       u_char *end,
...
u_char *nxt_conf_json_print (u_char *p, const nxt_conf_value_t *value,
                             nxt_conf_json_pretty_t *pretty);
void nxt_conf_json_position (u_char *start, const u_char *pos,
                             nxt_uint_t *line, nxt_uint_t *column);
...
nxt_int_t nxt_conf_set_member_string_dup (nxt_conf_value_t *object,
                                          nxt_mp_t *mp, const nxt_str_t *name,
