...
static njs_int_t nxt_http_js_ext_uri(njs_vm_t* vm,
                                     njs_object_prop_t* prop,
                                     njs_value_t* value,
                                     njs_value_t* setval,
                                     njs_value_t* retval);
static njs_int_t nxt_http_js_ext_host(njs_vm_t* vm,
                                      njs_object_prop_t* prop,
                                      njs_value_t* value,
                                      njs_value_t* setval,
                                      njs_value_t* retval);
...
static njs_int_t nxt_http_js_ext_get_cookie(njs_vm_t* vm,
                                            ...
                                            njs_value_t* setval,
                                            njs_value_t* retval);
static njs_int_t nxt_http_js_ext_keys_cookie(njs_vm_t* vm,
                                             njs_value_t* value,
                                             njs_value_t* keys);
static njs_int_t nxt_http_js_ext_get_var(njs_vm_t* vm,
                                         njs_object_prop_t* prop,
                                         njs_value_t* value,
                                         njs_value_t* setval,
                                         njs_value_t* retval);
...
static njs_int_t nxt_http_js_ext_remote_addr(njs_vm_t* vm,
  ...
  return njs_vm_value_string_create(vm, retval, nxt_sockaddr_address(r->remote),
