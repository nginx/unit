...
#define nxt_mem_unmap(addr, ctx, len) nxt_mem_munmap(addr, len)

NXT_EXPORT void *nxt_mem_mmap(void *addr, size_t len, nxt_uint_t protection, nxt_uint_t flags, nxt_fd_t fd,
                              nxt_off_t offset);
