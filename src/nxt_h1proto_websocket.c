...
static void nxt_h1p_conn_ws_keepalive (nxt_task_t *task, void *obj,
                                       void *data);
...
static const nxt_ws_error_t nxt_ws_err_out_of_memory
    = { NXT_WEBSOCKET_CR_INTERNAL_SERVER_ERROR, 0,
...
static const nxt_conn_state_t
    ...
    = {
        ...
        .timer_data
        = offsetof (nxt_socket_conf_t, websocket_conf.read_timeout),
        .timer_autoreset = 1,
      };
