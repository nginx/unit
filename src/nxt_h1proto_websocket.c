...
static const nxt_conn_state_t
    nxt_h1p_read_ws_frame_header_state nxt_aligned(64) = {
...
static const nxt_conn_state_t
    nxt_h1p_read_ws_frame_payload_state nxt_aligned(64) = {
...
static void nxt_h1p_conn_ws_error_sent(nxt_task_t *task, void *obj,
                                       void *data) {
  nxt_http_request_t *r;
