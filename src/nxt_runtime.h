...
#define nxt_runtime_process_next(rt, lhe) nxt_lvlhsh_each(&rt->processes, lhe)
...
NXT_EXPORT nxt_port_t* nxt_runtime_port_find(nxt_runtime_t* rt,
                                             nxt_pid_t pid,
...
/* STUB */
void nxt_cdecl nxt_log_time_handler(nxt_uint_t level,
                                    nxt_log_t* log,
                                    const char* fmt,
                                    ...);
...
#define nxt_runtime_process_each(rt, process)                             \
  do {                                                                    \
    ...
    nxt_process_t* _nxt;                                                  \
                                                                          \
    for (process = nxt_runtime_process_first(rt, &_lhe); process != NULL; \
         process = _nxt) {                                                \
