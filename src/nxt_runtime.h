...
NXT_EXPORT nxt_port_t *nxt_runtime_port_find(nxt_runtime_t *rt, nxt_pid_t pid, nxt_port_id_t port_id);
...
#define nxt_runtime_process_each(rt, process)                                                                          \
    ...
    {                                                                                                                  \
        ...
        nxt_process_t *_nxt;                                                                                           \
                                                                                                                       \
        for (process = nxt_runtime_process_first(rt, &_lhe); process != NULL; process = _nxt)                          \
        {                                                                                                              \
                                                                                                                       \
