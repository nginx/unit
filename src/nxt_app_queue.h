...
nxt_inline nxt_int_t nxt_app_queue_send(nxt_app_queue_t volatile *q,
                                        const void *p, uint8_t size,
                                        uint32_t tracking, int *notify,
                                        uint32_t *cookie) {
  int n;
...
nxt_inline nxt_bool_t nxt_app_queue_cancel(nxt_app_queue_t volatile *q,
                                           uint32_t cookie, uint32_t tracking) {
  nxt_app_queue_item_t *qi;
...
nxt_inline ssize_t nxt_app_queue_recv(nxt_app_queue_t volatile *q, void *p,
                                      uint32_t *cookie) {
  ssize_t res;
  nxt_app_queue_item_t *qi;
  nxt_app_nncq_atomic_t i;
