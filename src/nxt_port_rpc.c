...
static void nxt_port_rpc_remove_from_peers(nxt_task_t* task,
                                           nxt_port_t* port,
...
nxt_inline void nxt_port_rpc_lhq_stream(nxt_lvlhsh_query_t* lhq,
                                        uint32_t* stream) {
...
nxt_inline void nxt_port_rpc_lhq_peer(nxt_lvlhsh_query_t* lhq,
                                      nxt_pid_t* peer) {
...
uint32_t nxt_port_rpc_register_handler(nxt_task_t* task,
                                       nxt_port_t* port,
                                       nxt_port_rpc_handler_t ready_handler,
                                       nxt_port_rpc_handler_t error_handler,
                                       nxt_pid_t peer,
...
void* nxt_port_rpc_register_handler_ex(nxt_task_t* task,
                                       nxt_port_t* port,
                                       nxt_port_rpc_handler_t ready_handler,
                                       nxt_port_rpc_handler_t error_handler,
                                       size_t ex_size) {
...
void nxt_port_rpc_ex_set_peer(nxt_task_t* task,
                              nxt_port_t* port,
                              void* ex,
                              nxt_pid_t peer) {
  nxt_int_t ret;
...
void nxt_port_rpc_remove_peer(nxt_task_t* task,
                              nxt_port_t* port,
                              nxt_pid_t peer) {
  uint8_t last;
  uint32_t stream;
