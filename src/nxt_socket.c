...
nxt_socket_t nxt_socket_create(nxt_task_t *task, nxt_uint_t domain,
                               nxt_uint_t type, nxt_uint_t protocol,
                               nxt_uint_t flags) {
  nxt_socket_t s;
...
void nxt_socket_defer_accept(nxt_task_t *task, nxt_socket_t s,
                             nxt_sockaddr_t *sa) {
...
nxt_int_t nxt_socket_getsockopt(nxt_task_t *task, nxt_socket_t s,
...
nxt_int_t nxt_socket_setsockopt(nxt_task_t *task, nxt_socket_t s,
...
nxt_int_t nxt_socket_bind(nxt_task_t *task, nxt_socket_t s,
                          nxt_sockaddr_t *sa) {
...
nxt_int_t nxt_socket_connect(nxt_task_t *task, nxt_socket_t s,
                             nxt_sockaddr_t *sa) {
  nxt_err_t err;
  nxt_int_t ret;
  nxt_uint_t level;
