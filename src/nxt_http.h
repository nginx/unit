...
typedef struct {
  ...
  void (*header_send)(nxt_task_t* task,
                      nxt_http_request_t* r,
  ...
  void (*ws_frame_start)(nxt_task_t* task,
                         nxt_http_request_t* r,
                         nxt_buf_t* ws_frame);
...
nxt_inline u_char* nxt_http_date(u_char* buf, struct tm* tm) {
  ...
  return nxt_sprintf(buf, buf + NXT_HTTP_DATE_LEN,
                     "%s, %02d %s %4d %02d:%02d:%02d GMT", week[tm->tm_wday],
...
void nxt_http_request_error(nxt_task_t* task,
                            nxt_http_request_t* r,
                            nxt_http_status_t status);
void nxt_http_request_read_body(nxt_task_t* task, nxt_http_request_t* r);
void nxt_http_request_header_send(nxt_task_t* task,
                                  nxt_http_request_t* r,
                                  nxt_work_handler_t body_handler,
                                  void* data);
void nxt_http_request_ws_frame_start(nxt_task_t* task,
                                     nxt_http_request_t* r,
                                     nxt_buf_t* ws_frame);
void nxt_http_request_send(nxt_task_t* task,
                           nxt_http_request_t* r,
                           nxt_buf_t* out);
nxt_buf_t* nxt_http_buf_mem(nxt_task_t* task,
                            nxt_http_request_t* r,
                            size_t size);
...
nxt_int_t nxt_http_request_host(void* ctx,
                                nxt_http_field_t* field,
                                uintptr_t data);
nxt_int_t nxt_http_request_field(void* ctx,
                                 nxt_http_field_t* field,
                                 uintptr_t offset);
nxt_int_t nxt_http_request_content_length(void* ctx,
                                          nxt_http_field_t* field,
                                          uintptr_t data);
...
int64_t nxt_http_field_hash(nxt_mp_t* mp,
                            nxt_str_t* name,
...
nxt_int_t nxt_http_action_init(nxt_task_t* task,
                               ...
                               nxt_conf_value_t* cv,
                               nxt_http_action_t* action);
void nxt_http_request_action(nxt_task_t* task,
                             nxt_http_request_t* r,
                             nxt_http_action_t* action);

nxt_int_t nxt_upstreams_create(nxt_task_t* task,
                               nxt_router_temp_conf_t* tmcf,
...
nxt_int_t nxt_http_static_init(nxt_task_t* task,
                               nxt_router_temp_conf_t* tmcf,
                               nxt_http_action_t* action,
                               nxt_http_action_conf_t* acf);
nxt_int_t nxt_http_static_mtypes_init(nxt_mp_t* mp, nxt_lvlhsh_t* hash);
nxt_int_t nxt_http_static_mtypes_hash_add(nxt_mp_t* mp,
                                          nxt_lvlhsh_t* hash,
...
nxt_http_action_t* nxt_http_application_handler(nxt_task_t* task,
                                                nxt_http_request_t* r,
                                                nxt_http_action_t* action);
nxt_int_t nxt_upstream_find(nxt_upstreams_t* upstreams,
                            nxt_str_t* name,
                            nxt_http_action_t* action);
...
nxt_int_t nxt_http_proxy_init(nxt_mp_t* mp,
                              nxt_http_action_t* action,
                              nxt_http_action_conf_t* acf);
nxt_int_t nxt_http_proxy_date(void* ctx,
                              nxt_http_field_t* field,
                              uintptr_t data);
nxt_int_t nxt_http_proxy_content_length(void* ctx,
                                        nxt_http_field_t* field,
                                        uintptr_t data);
nxt_int_t nxt_http_proxy_skip(void* ctx,
                              nxt_http_field_t* field,
                              uintptr_t data);
nxt_buf_t* nxt_http_proxy_buf_mem_alloc(nxt_task_t* task,
                                        nxt_http_request_t* r,
                                        size_t size);
void nxt_http_proxy_buf_mem_free(nxt_task_t* task,
                                 nxt_http_request_t* r,
                                 nxt_buf_t* b);
...
void nxt_h1p_websocket_first_frame_start(nxt_task_t* task,
                                         nxt_http_request_t* r,
                                         nxt_buf_t* ws_frame);
void nxt_h1p_websocket_frame_start(nxt_task_t* task,
                                   nxt_http_request_t* r,
                                   nxt_buf_t* ws_frame);
...
int nxt_http_cond_value(nxt_task_t* task,
                        nxt_http_request_t* r,
