...
static nxt_var_ref_t *nxt_var_ref_get (nxt_tstr_state_t *state,
                                       nxt_str_t *name, nxt_mp_t *mp);

static nxt_int_t nxt_var_cache_test (nxt_lvlhsh_query_t *lhq, void *data);
static nxt_str_t *nxt_var_cache_value (nxt_task_t *task,
...
nxt_var_interpreter (nxt_task_t *task, nxt_tstr_state_t *state,
                     nxt_var_cache_t *cache, nxt_var_t *var, nxt_str_t *str,
                     void *ctx, nxt_bool_t logging)
{
  u_char *p, *src;
