...
void nxt_thread_init_data(nxt_thread_specific_data_t tsd)
{
    void *p;
    nxt_err_t err;
    pthread_key_t key;
...
nxt_int_t nxt_thread_create(nxt_thread_handle_t *handle, nxt_thread_link_t *link)
{
    nxt_err_t err;
...
nxt_thread_t *nxt_thread_init(void)
{
    nxt_thread_t *thr;
...
void nxt_thread_exit(nxt_thread_t *thr)
{
    nxt_thread_link_t *link;
...
void nxt_thread_cancel(nxt_thread_handle_t handle)
{
    nxt_err_t err;
...
void nxt_thread_wait(nxt_thread_handle_t handle)
{
    nxt_err_t err;
...
nxt_tid_t nxt_thread_tid(nxt_thread_t *thr)
{
