...
static void nxt_kqueue_disable (nxt_event_engine_t *engine,
                                nxt_fd_event_t *ev);
...
static void nxt_kqueue_conn_connected (nxt_task_t *task, void *obj,
                                       void *data);
static void nxt_kqueue_listen_handler (nxt_task_t *task, void *obj,
                                       void *data);
...
static nxt_int_t
nxt_kqueue_add_signal (nxt_event_engine_t *engine,
                       const nxt_sig_event_t *sigev)
{
  int signo;
  struct kevent kev;
