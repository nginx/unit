...
static void nxt_cyassl_conn_init(nxt_thread_t* thr,
...
static void nxt_cyassl_conn_io_shutdown(nxt_thread_t* thr,
                                        void* obj,
                                        void* data);
static ssize_t nxt_cyassl_conn_io_write_chunk(nxt_thread_t* thr,
                                              ...
                                              nxt_buf_t* b,
                                              size_t limit);
static ssize_t nxt_cyassl_conn_io_send(nxt_event_conn_t* c,
                                       void* buf,
                                       size_t size);
...
static void nxt_cdecl nxt_cyassl_conn_error(nxt_event_conn_t* c,
                                            nxt_err_t err,
                                            const char* fmt,
                                            ...);
static nxt_uint_t nxt_cyassl_log_error_level(nxt_event_conn_t* c,
                                             nxt_err_t err,
                                             int ssl_error);
static void nxt_cdecl nxt_cyassl_log_error(nxt_uint_t level,
                                           nxt_log_t* log,
                                           int ret,
                                           const char* fmt,
                                           ...);
...
static nxt_int_t nxt_cyassl_server_init(nxt_ssltls_conf_t* conf) {
  ...
  if (err != SSL_SUCCESS) {
    nxt_cyassl_log_error(NXT_LOG_ALERT, thr->log, err,
                         "CyaSSL_CTX_use_PrivateKey_file(\"%s\") failed", key);
    goto fail;
  }
...
static void nxt_cyassl_conn_handshake(nxt_thread_t* thr,
                                      void* obj,
                                      void* data) {
  int ret;
  nxt_int_t n;
