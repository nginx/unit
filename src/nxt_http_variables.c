...
static nxt_int_t nxt_http_var_dollar(nxt_task_t* task,
                                     nxt_str_t* str,
                                     void* ctx,
                                     void* data);
static nxt_int_t nxt_http_var_request_time(nxt_task_t* task,
                                           nxt_str_t* str,
                                           void* ctx,
                                           void* data);
static nxt_int_t nxt_http_var_method(nxt_task_t* task,
                                     nxt_str_t* str,
                                     void* ctx,
                                     void* data);
static nxt_int_t nxt_http_var_request_uri(nxt_task_t* task,
                                          ...
                                          void* ctx,
                                          void* data);
static nxt_int_t nxt_http_var_uri(nxt_task_t* task,
                                  nxt_str_t* str,
                                  void* ctx,
                                  void* data);
static nxt_int_t nxt_http_var_host(nxt_task_t* task,
                                   nxt_str_t* str,
                                   void* ctx,
                                   void* data);
static nxt_int_t nxt_http_var_remote_addr(nxt_task_t* task,
                                          nxt_str_t* str,
                                          void* ctx,
                                          void* data);
static nxt_int_t nxt_http_var_time_local(nxt_task_t* task,
                                         nxt_str_t* str,
                                         void* ctx,
                                         void* data);
static u_char* nxt_http_log_date(u_char* buf,
                                 nxt_realtime_t* now,
                                 struct tm* tm,
                                 size_t size,
                                 const char* format);
static nxt_int_t nxt_http_var_request_line(nxt_task_t* task,
                                           nxt_str_t* str,
                                           void* ctx,
                                           void* data);
static nxt_int_t nxt_http_var_request_id(nxt_task_t* task,
                                         nxt_str_t* str,
                                         void* ctx,
                                         void* data);
static nxt_int_t nxt_http_var_status(nxt_task_t* task,
                                     nxt_str_t* str,
                                     void* ctx,
                                     void* data);
static nxt_int_t nxt_http_var_body_bytes_sent(nxt_task_t* task,
                                              nxt_str_t* str,
                                              void* ctx,
                                              void* data);
static nxt_int_t nxt_http_var_referer(nxt_task_t* task,
                                      nxt_str_t* str,
                                      void* ctx,
                                      void* data);
static nxt_int_t nxt_http_var_user_agent(nxt_task_t* task,
                                         nxt_str_t* str,
                                         void* ctx,
                                         void* data);
...
static nxt_int_t nxt_http_var_response_transfer_encoding(nxt_task_t* task,
                                                         ...
                                                         void* ctx,
                                                         void* data);
static nxt_int_t nxt_http_var_arg(nxt_task_t* task,
                                  nxt_str_t* str,
                                  void* ctx,
                                  void* data);
static nxt_int_t nxt_http_var_header(nxt_task_t* task,
                                     nxt_str_t* str,
                                     void* ctx,
                                     void* data);
static nxt_int_t nxt_http_var_cookie(nxt_task_t* task,
                                     nxt_str_t* str,
                                     void* ctx,
                                     void* data);
static nxt_int_t nxt_http_var_response_header(nxt_task_t* task,
                                              nxt_str_t* str,
                                              void* ctx,
                                              void* data);
...
nxt_int_t nxt_http_unknown_var_ref(nxt_mp_t* mp,
                                   nxt_var_ref_t* ref,
                                   nxt_str_t* name) {
  int64_t hash;
  nxt_str_t str, *lower;
...
static nxt_int_t nxt_http_var_request_id(nxt_task_t* task,
  ...
  (void)nxt_sprintf(str->start, str->start + 32, "%08xD%08xD%08xD%08xD",
                    nxt_random(rand), nxt_random(rand), nxt_random(rand),
                    nxt_random(rand));
