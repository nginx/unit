...
static nxt_int_t nxt_http_var_status(nxt_task_t *task, nxt_str_t *str,
    void *ctx, uint16_t field);
static nxt_int_t nxt_http_var_bytes_sent(nxt_task_t *task, nxt_str_t *str,
    void *ctx, uint16_t field);
...
static nxt_var_decl_t  nxt_http_vars[] = {
    {
        ...
        .name = nxt_string("bytes_sent"),
        .handler = nxt_http_var_bytes_sent,
    }, {
...
static nxt_int_t
nxt_http_var_bytes_sent(nxt_task_t *task, nxt_str_t *str, void *ctx,
    uint16_t field)
{
    nxt_off_t           bytes;
    nxt_http_request_t  *r;
