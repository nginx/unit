...
static nxt_int_t nxt_http_var_dollar(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_request_time(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_method(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_request_uri(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_uri(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_host(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_remote_addr(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_time_local(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static u_char *nxt_http_log_date(u_char *buf, nxt_realtime_t *now, struct tm *tm, size_t size, const char *format);
static nxt_int_t nxt_http_var_request_line(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_request_id(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_status(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_body_bytes_sent(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_referer(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_user_agent(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_response_connection(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_response_content_length(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_response_transfer_encoding(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_arg(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_header(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_cookie(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
static nxt_int_t nxt_http_var_response_header(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data);
...
nxt_int_t nxt_http_unknown_var_ref(nxt_mp_t *mp, nxt_var_ref_t *ref, nxt_str_t *name)
{
    int64_t hash;
    nxt_str_t str, *lower;
...
static nxt_int_t nxt_http_var_request_time(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data)
{
    ...
    p = nxt_sprintf(str->start, str->start + NXT_TIME_T_LEN, "%T.%03M", (nxt_time_t)ms / 1000, ms % 1000);
...
static nxt_int_t nxt_http_var_time_local(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data)
{
    ...
    str->length = nxt_thread_time_string(task->thread, &date_cache, str->start) - str->start;
...
static u_char *nxt_http_log_date(u_char *buf, nxt_realtime_t *now, struct tm *tm, size_t size, const char *format)
{
    ...
    return nxt_sprintf(buf, buf + size, format, tm->tm_mday, month[tm->tm_mon], tm->tm_year + 1900, tm->tm_hour,
                       tm->tm_min, tm->tm_sec, sign, gmtoff / 60, gmtoff % 60);
}
...
static nxt_int_t nxt_http_var_request_id(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data)
{
    ...
    (void)nxt_sprintf(str->start, str->start + 32, "%08xD%08xD%08xD%08xD", nxt_random(rand), nxt_random(rand),
...
static nxt_int_t nxt_http_var_response_content_length(nxt_task_t *task, nxt_str_t *str, void *ctx, void *data)
{
    ...
    if (r->resp.content_length_n >= 0)
    {
        ...
        p = nxt_sprintf(str->start, str->start + NXT_OFF_T_LEN, "%O", r->resp.content_length_n);
...
static int nxt_http_field_name_cmp(nxt_str_t *name, nxt_http_field_t *field)
{
    size_t i;
    u_char c1, c2;
