...
#endif
static void* nxt_mp_alloc_large(nxt_mp_t* mp,
                                size_t alignment,
                                size_t size,
                                nxt_bool_t freeable);
...
static const char* nxt_mp_chunk_free(nxt_mp_t* mp,
...
nxt_mp_t* nxt_mp_create(size_t cluster_size,
...
nxt_bool_t nxt_mp_test_sizes(size_t cluster_size,
                             size_t page_alignment,
                             size_t page_size,
                             size_t min_chunk_size) {
  nxt_bool_t valid;
...
nxt_int_t nxt_mp_cleanup(nxt_mp_t* mp,
