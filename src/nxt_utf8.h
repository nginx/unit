...
NXT_EXPORT nxt_int_t nxt_utf8_casecmp(const u_char *start1, const u_char *start2, size_t len1, size_t len2);
...
nxt_inline const u_char *nxt_utf8_next(const u_char *p, const u_char *end)
{
    u_char c;
