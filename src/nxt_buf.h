...
NXT_EXPORT nxt_buf_t* nxt_buf_mem_alloc(nxt_mp_t* mp,
                                        size_t size,
                                        nxt_uint_t flags);
NXT_EXPORT nxt_buf_t* nxt_buf_mem_ts_alloc(nxt_task_t* task,
                                           nxt_mp_t* mp,
                                           size_t size);
NXT_EXPORT nxt_buf_t* nxt_buf_file_alloc(nxt_mp_t* mp,
                                         size_t size,
                                         nxt_uint_t flags);
...
NXT_EXPORT nxt_buf_t* nxt_buf_make_plain(nxt_mp_t* mp,
                                         nxt_buf_t* src,
                                         size_t size);

nxt_inline nxt_buf_t* nxt_buf_chk_make_plain(nxt_mp_t* mp,
                                             nxt_buf_t* src,
                                             size_t size) {
...
nxt_inline nxt_buf_t* nxt_buf_cpy(nxt_buf_t* b,
                                  const void* src,
                                  size_t length) {
...
nxt_inline void nxt_buf_dummy_completion(nxt_task_t* task,
                                         void* obj,
                                         void* data) {}
