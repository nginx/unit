 ...
 */
typedef intptr_t (*nxt_rbtree_compare_t)(nxt_rbtree_node_t *node1, nxt_rbtree_node_t *node2);

#define nxt_rbtree_root(tree) ((tree)->sentinel.left)

#define nxt_rbtree_sentinel(tree) (&(tree)->sentinel)

#define nxt_rbtree_is_empty(tree) (nxt_rbtree_root(tree) == nxt_rbtree_sentinel(tree))

#define nxt_rbtree_min(tree) nxt_rbtree_branch_min(tree, &(tree)->sentinel)

nxt_inline nxt_rbtree_node_t *nxt_rbtree_branch_min(nxt_rbtree_t *tree, nxt_rbtree_node_t *node)
{
...
#define nxt_rbtree_is_there_successor(tree, node) ((node) != nxt_rbtree_sentinel(tree))

nxt_inline nxt_rbtree_node_t *nxt_rbtree_node_successor(nxt_rbtree_t *tree, nxt_rbtree_node_t *node)
{
    nxt_rbtree_node_t *parent;
...
NXT_EXPORT void nxt_rbtree_init(nxt_rbtree_t *tree, nxt_rbtree_compare_t compare);
NXT_EXPORT void nxt_rbtree_insert(nxt_rbtree_t *tree, nxt_rbtree_part_t *node);
NXT_EXPORT nxt_rbtree_node_t *nxt_rbtree_find(nxt_rbtree_t *tree, nxt_rbtree_part_t *node);
NXT_EXPORT nxt_rbtree_node_t *nxt_rbtree_find_less_or_equal(nxt_rbtree_t *tree, nxt_rbtree_part_t *node);
NXT_EXPORT nxt_rbtree_node_t *nxt_rbtree_find_greater_or_equal(nxt_rbtree_t *tree, nxt_rbtree_part_t *node);
 ...
 */
NXT_EXPORT nxt_rbtree_node_t *nxt_rbtree_destroy_next(nxt_rbtree_t *tree, nxt_rbtree_node_t **next);
