...
static void nxt_job_thread_return_handler(nxt_task_t* task,
                                          void* obj,
                                          void* data);
...
void nxt_job_start(nxt_task_t* task,
                   nxt_job_t* job,
...
void nxt_job_return(nxt_task_t* task,
                    nxt_job_t* job,
                    nxt_work_handler_t handler) {
  ...
  nxt_work_queue_add(&task->thread->engine->fast_work_queue, handler, job->task,
                     job, job->data);
}
