...
NXT_EXPORT void nxt_job_start(nxt_task_t *task, nxt_job_t *job, nxt_work_handler_t handler);
NXT_EXPORT void nxt_job_return(nxt_task_t *task, nxt_job_t *job, nxt_work_handler_t handler);
