...
#define nxt_event_signal(sig, handler) {sig, handler, #sig}

#define nxt_event_signal_end {0, NULL, NULL}
...
#define nxt_event_engine_signals_start(engine) nxt_signal_thread_start(engine)

#define nxt_event_engine_signals_stop(engine) nxt_signal_thread_stop(engine)
