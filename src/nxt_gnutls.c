...
static nxt_int_t nxt_gnutls_conn_test_error(nxt_thread_t *thr,
                                            nxt_event_conn_t *c, ssize_t err,
...
static void nxt_gnutls_conn_handshake(nxt_thread_t *thr, void *obj,
                                      void *data) {
  int err;
  nxt_int_t ret;
  nxt_event_conn_t *c;
...
static void nxt_gnutls_conn_log_error(nxt_event_conn_t *c, ssize_t err,
                                      const char *fmt, ...) {
  va_list args;
  nxt_uint_t level;
...
static void nxt_gnutls_log_error(nxt_uint_t level, nxt_log_t *log, int err,
                                 const char *fmt, ...) {
  va_list args;
  u_char *p, msg[NXT_MAX_ERROR_STR];
