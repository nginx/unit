...
#define NXT_UNIT_LOCAL_BUF_SIZE (NXT_UNIT_MAX_PLAIN_SIZE + sizeof(nxt_port_msg_t))
...
static int nxt_unit_ctx_init(nxt_unit_impl_t *lib, nxt_unit_ctx_impl_t *ctx_impl, void *data);
...
nxt_inline void nxt_unit_mmap_buf_insert(nxt_unit_mmap_buf_t **head, nxt_unit_mmap_buf_t *mmap_buf);
nxt_inline void nxt_unit_mmap_buf_insert_tail(nxt_unit_mmap_buf_t **prev, nxt_unit_mmap_buf_t *mmap_buf);
nxt_inline void nxt_unit_mmap_buf_unlink(nxt_unit_mmap_buf_t *mmap_buf);
static int nxt_unit_read_env(nxt_unit_port_t *ready_port, nxt_unit_port_t *router_port, nxt_unit_port_t *read_port,
                             int *shared_port_fd, int *shared_queue_fd, int *log_fd, uint32_t *stream,
                             uint32_t *shm_limit, uint32_t *request_limit);
static int nxt_unit_ready(nxt_unit_ctx_t *ctx, int ready_fd, uint32_t stream, int queue_fd);
static int nxt_unit_process_msg(nxt_unit_ctx_t *ctx, nxt_unit_read_buf_t *rbuf, nxt_unit_request_info_t **preq);
static int nxt_unit_process_new_port(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg);
static int nxt_unit_ctx_ready(nxt_unit_ctx_t *ctx);
static int nxt_unit_process_req_headers(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg,
                                        nxt_unit_request_info_t **preq);
static int nxt_unit_process_req_body(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg);
static int nxt_unit_request_check_response_port(nxt_unit_request_info_t *req, nxt_unit_port_id_t *port_id);
static int nxt_unit_send_req_headers_ack(nxt_unit_request_info_t *req);
static int nxt_unit_process_websocket(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg);
static int nxt_unit_process_shm_ack(nxt_unit_ctx_t *ctx);
static nxt_unit_request_info_impl_t *nxt_unit_request_info_get(nxt_unit_ctx_t *ctx);
...
static nxt_unit_websocket_frame_impl_t *nxt_unit_websocket_frame_get(nxt_unit_ctx_t *ctx);
static void nxt_unit_websocket_frame_release(nxt_unit_websocket_frame_t *ws);
static void nxt_unit_websocket_frame_free(nxt_unit_ctx_t *ctx, nxt_unit_websocket_frame_impl_t *ws);
...
static int nxt_unit_mmap_buf_send(nxt_unit_request_info_t *req, nxt_unit_mmap_buf_t *mmap_buf, int last);
...
static nxt_unit_read_buf_t *nxt_unit_read_buf_get_impl(nxt_unit_ctx_impl_t *ctx_impl);
static void nxt_unit_read_buf_release(nxt_unit_ctx_t *ctx, nxt_unit_read_buf_t *rbuf);
static nxt_unit_mmap_buf_t *nxt_unit_request_preread(nxt_unit_request_info_t *req, size_t size);
static ssize_t nxt_unit_buf_read(nxt_unit_buf_t **b, uint64_t *len, void *dst, size_t size);
static nxt_port_mmap_header_t *nxt_unit_mmap_get(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, nxt_chunk_id_t *c, int *n,
                                                 int min_n);
...
static nxt_port_mmap_header_t *nxt_unit_new_mmap(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, int n);
static int nxt_unit_shm_open(nxt_unit_ctx_t *ctx, size_t size);
static int nxt_unit_send_mmap(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, int fd);
static int nxt_unit_get_outgoing_buf(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, uint32_t size, uint32_t min_size,
                                     nxt_unit_mmap_buf_t *mmap_buf, char *local_buf);
static int nxt_unit_incoming_mmap(nxt_unit_ctx_t *ctx, pid_t pid, int fd);

static void nxt_unit_awake_ctx(nxt_unit_ctx_t *ctx, nxt_unit_ctx_impl_t *ctx_impl);
...
static int nxt_unit_check_rbuf_mmap(nxt_unit_ctx_t *ctx, nxt_unit_mmaps_t *mmaps, pid_t pid, uint32_t id,
                                    nxt_port_mmap_header_t **hdr, nxt_unit_read_buf_t *rbuf);
static int nxt_unit_mmap_read(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg, nxt_unit_read_buf_t *rbuf);
static int nxt_unit_get_mmap(nxt_unit_ctx_t *ctx, pid_t pid, uint32_t id);
static void nxt_unit_mmap_release(nxt_unit_ctx_t *ctx, nxt_port_mmap_header_t *hdr, void *start, uint32_t size);
...
static nxt_unit_process_t *nxt_unit_process_find(nxt_unit_impl_t *lib, pid_t pid, int remove);
...
static int nxt_unit_process_port_msg_impl(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port);
static void nxt_unit_ctx_free(nxt_unit_ctx_impl_t *ctx_impl);
static nxt_unit_port_t *nxt_unit_create_port(nxt_unit_ctx_t *ctx);

static int nxt_unit_send_port(nxt_unit_ctx_t *ctx, nxt_unit_port_t *dst, nxt_unit_port_t *port, int queue_fd);

nxt_inline void nxt_unit_port_use(nxt_unit_port_t *port);
nxt_inline void nxt_unit_port_release(nxt_unit_port_t *port);
static nxt_unit_port_t *nxt_unit_add_port(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, void *queue);
static void nxt_unit_process_awaiting_req(nxt_unit_ctx_t *ctx, nxt_queue_t *awaiting_req);
static void nxt_unit_remove_port(nxt_unit_impl_t *lib, nxt_unit_ctx_t *ctx, nxt_unit_port_id_t *port_id);
static nxt_unit_port_t *nxt_unit_remove_port_unsafe(nxt_unit_impl_t *lib, nxt_unit_port_id_t *port_id);
static void nxt_unit_remove_pid(nxt_unit_impl_t *lib, pid_t pid);
static void nxt_unit_remove_process(nxt_unit_impl_t *lib, nxt_unit_process_t *process);
...
static ssize_t nxt_unit_port_send(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, const void *buf, size_t buf_size,
                                  const nxt_send_oob_t *oob);
static ssize_t nxt_unit_sendmsg(nxt_unit_ctx_t *ctx, int fd, const void *buf, size_t buf_size,
                                const nxt_send_oob_t *oob);
static int nxt_unit_ctx_port_recv(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, nxt_unit_read_buf_t *rbuf);
nxt_inline void nxt_unit_rbuf_cpy(nxt_unit_read_buf_t *dst, nxt_unit_read_buf_t *src);
static int nxt_unit_shared_port_recv(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, nxt_unit_read_buf_t *rbuf);
static int nxt_unit_port_recv(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, nxt_unit_read_buf_t *rbuf);
static int nxt_unit_port_queue_recv(nxt_unit_port_t *port, nxt_unit_read_buf_t *rbuf);
static int nxt_unit_app_queue_recv(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, nxt_unit_read_buf_t *rbuf);
nxt_inline int nxt_unit_close(int fd);
static int nxt_unit_fd_blocking(int fd);

static int nxt_unit_port_hash_add(nxt_lvlhsh_t *port_hash, nxt_unit_port_t *port);
static nxt_unit_port_t *nxt_unit_port_hash_find(nxt_lvlhsh_t *port_hash, nxt_unit_port_id_t *port_id, int remove);

static int nxt_unit_request_hash_add(nxt_unit_ctx_t *ctx, nxt_unit_request_info_t *req);
static nxt_unit_request_info_t *nxt_unit_request_hash_find(nxt_unit_ctx_t *ctx, uint32_t stream, int remove);
...
nxt_unit_ctx_t *nxt_unit_init(nxt_unit_init_t *init)
{
    ...
    if (init->ready_port.id.pid != 0 && init->ready_stream != 0 && init->read_port.id.pid != 0)
    {
        ...
        nxt_unit_port_id_init(&ready_port.id, ready_port.id.pid, ready_port.id.id);
        nxt_unit_port_id_init(&router_port.id, router_port.id.pid, router_port.id.id);
    ...
    {
        rc = nxt_unit_read_env(&ready_port, &router_port, &read_port, &shared_port.in_fd, &shared_queue_fd,
                               &lib->log_fd, &ready_stream, &shm_limit, &request_limit);
        if (nxt_slow_path(rc != NXT_UNIT_OK))
        {
            goto fail;
        }

        lib->shm_mmap_limit = (shm_limit + PORT_MMAP_DATA_SIZE - 1) / PORT_MMAP_DATA_SIZE;
    ...
    mem = mmap(NULL, sizeof(nxt_port_queue_t), PROT_READ | PROT_WRITE, MAP_SHARED, queue_fd, 0);
    if (nxt_slow_path(mem == MAP_FAILED))
    {
        nxt_unit_alert(ctx, "mmap(%d) failed: %s (%d)", queue_fd, strerror(errno), errno);
    ...
    nxt_unit_port_id_init(&shared_port.id, read_port.id.pid, NXT_UNIT_SHARED_PORT_ID);

    mem = mmap(NULL, sizeof(nxt_app_queue_t), PROT_READ | PROT_WRITE, MAP_SHARED, shared_queue_fd, 0);
    if (nxt_slow_path(mem == MAP_FAILED))
    {
        nxt_unit_alert(ctx, "mmap(%d) failed: %s (%d)", shared_queue_fd, strerror(errno), errno);
...
static nxt_unit_impl_t *nxt_unit_create(nxt_unit_init_t *init)
{
    ...
    lib = nxt_unit_malloc(NULL, sizeof(nxt_unit_impl_t) + init->request_data_size);
    if (nxt_slow_path(lib == NULL))
    {
    ...
    lib->shm_mmap_limit = (init->shm_limit + PORT_MMAP_DATA_SIZE - 1) / PORT_MMAP_DATA_SIZE;
                             ...
                             uint32_t *shm_limit, uint32_t *request_limit)
{
    ...
    {
        nxt_unit_alert(NULL, "%s is not in the current environment", NXT_UNIT_INIT_ENV);
    ...
    {
        nxt_unit_alert(NULL, "Unit version not found in %s=\"%s\"", NXT_UNIT_INIT_ENV, unit_init);
    ...
    rc = version_length != nxt_length(NXT_VERSION) || memcmp(unit_init, NXT_VERSION, nxt_length(NXT_VERSION));
    ...
    rc = sscanf(vars,
                ...
                "%d,%d;"
                "%d,%" PRIu32 ",%" PRIu32,
                &ready_stream, &ready_pid, &ready_id, &ready_fd, &router_pid, &router_id, &router_fd, &read_pid,
                &read_id, &read_in_fd, &read_out_fd, shared_port_fd, shared_queue_fd, log_fd, shm_limit, request_limit);
...
static int nxt_unit_process_msg(nxt_unit_ctx_t *ctx, nxt_unit_read_buf_t *rbuf, nxt_unit_request_info_t **preq)
{
    ...
    nxt_unit_debug(ctx, "#%" PRIu32 ": process message %d fd[0] %d fd[1] %d", port_msg->stream, (int)port_msg->type,
    ...
    {
        nxt_unit_alert(ctx, "#%" PRIu32 ": unknown message type (%d)", port_msg->stream, (int)port_msg->type);
        rc = NXT_UNIT_ERROR;
        goto done;
    }
    ...
    {
        nxt_unit_alert(ctx, "#%" PRIu32 ": fragmented message type (%d)", port_msg->stream, (int)port_msg->type);
        rc = NXT_UNIT_ERROR;
        goto done;
    }
    ...
    case _NXT_PORT_MSG_CHANGE_FILE:
        nxt_unit_debug(ctx, "#%" PRIu32 ": change_file: fd %d", port_msg->stream, recv_msg.fd[0]);

        if (dup2(recv_msg.fd[0], lib->log_fd) == -1)
        {
            nxt_unit_alert(ctx, "#%" PRIu32 ": dup2(%d, %d) failed: %s (%d)", port_msg->stream, recv_msg.fd[0],
                           lib->log_fd, strerror(errno), errno);
    ...
    case _NXT_PORT_MSG_MMAP:
        ...
        {
            nxt_unit_alert(ctx, "#%" PRIu32 ": invalid fd %d for mmap", port_msg->stream, recv_msg.fd[0]);
    ...
    case _NXT_PORT_MSG_REMOVE_PID:
        if (nxt_slow_path(recv_msg.size != sizeof(pid)))
        {
            nxt_unit_alert(ctx,
                           ...
                           "(%d != %d)",
                           port_msg->stream, (int)recv_msg.size, (int)sizeof(pid));
        ...
        nxt_unit_debug(ctx, "#%" PRIu32 ": remove_pid: %d", port_msg->stream, (int)pid);
    ...
    default:
        nxt_unit_alert(ctx, "#%" PRIu32 ": ignore message type: %d", port_msg->stream, (int)port_msg->type);
...
static int nxt_unit_process_new_port(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg)
{
    ...
    if (nxt_slow_path(recv_msg->fd[0] < 0))
    {
        nxt_unit_alert(ctx, "#%" PRIu32 ": invalid fd %d for new port", recv_msg->stream, recv_msg->fd[0]);
    ...
    nxt_unit_debug(ctx, "#%" PRIu32 ": new_port: port{%d,%d} fd[0] %d fd[1] %d", recv_msg->stream,
                   (int)new_port_msg->pid, (int)new_port_msg->id, recv_msg->fd[0], recv_msg->fd[1]);
    ...
    mem = mmap(NULL, sizeof(nxt_port_queue_t), PROT_READ | PROT_WRITE, MAP_SHARED, recv_msg->fd[1], 0);

    if (nxt_slow_path(mem == MAP_FAILED))
    {
        nxt_unit_alert(ctx, "mmap(%d) failed: %s (%d)", recv_msg->fd[1], strerror(errno), errno);
                                        ...
                                        nxt_unit_request_info_t **preq)
{
    ...
    {
        nxt_unit_warn(ctx, "#%" PRIu32 ": data is not in shared memory", recv_msg->stream);
    ...
    if (nxt_slow_path(recv_msg->size < sizeof(nxt_unit_request_t)))
    {
        nxt_unit_warn(ctx,
                      ...
                      "%d expected",
                      recv_msg->stream, (int)recv_msg->size, (int)sizeof(nxt_unit_request_t));
    ...
    {
        nxt_unit_warn(ctx, "#%" PRIu32 ": request info allocation failed", recv_msg->stream);
    ...
    nxt_unit_debug(ctx, "#%" PRIu32 ": %.*s %.*s (%d)", recv_msg->stream, (int)r->method_length,
                   (char *)nxt_unit_sptr_get(&r->method), (int)r->target_length, (char *)nxt_unit_sptr_get(&r->target),
    ...
    if (nxt_fast_path(res == NXT_UNIT_OK))
    {
        ...
        if (req->content_length > (uint64_t)(req->content_buf->end - req->content_buf->free))
        {
...
static int nxt_unit_request_check_response_port(nxt_unit_request_info_t *req, nxt_unit_port_id_t *port_id)
{
    ...
    if (nxt_fast_path(port != NULL))
    {
        ...
        if (nxt_fast_path(port_impl->ready))
        {
            ...
            nxt_unit_debug(ctx, "check_response_port: found port{%d,%d}", (int)port->id.pid, (int)port->id.id);
    ...
    {
        nxt_unit_alert(ctx, "check_response_port: malloc(%d) failed", (int)sizeof(nxt_unit_port_impl_t));
    ...
    if (nxt_slow_path(res != NXT_UNIT_OK))
    {
        nxt_unit_alert(ctx, "check_response_port: %d,%d hash_add failed", port->id.pid, port->id.id);
    ...
    {
        nxt_unit_alert(ctx, "check_response_port: process %d not found", port->id.pid);
...
static int nxt_unit_send_req_headers_ack(nxt_unit_request_info_t *req)
{
    ...
    res = nxt_unit_port_send(req->ctx, req->response_port, &msg, sizeof(msg), NULL);
...
static int nxt_unit_process_websocket(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg)
{
    ...
    if (cb->websocket_handler && recv_msg->size >= 2)
    {
        ...
        {
            nxt_unit_warn(ctx, "#%" PRIu32 ": websocket frame allocation failed", req_impl->stream);
        ...
        else
        {
            ...
            {
                nxt_unit_alert(ctx, "#%" PRIu32 ": failed to allocate buf", req_impl->stream);
        ...
        ws_impl->ws.payload_len = nxt_websocket_frame_payload_len(ws_impl->ws.header);
...
static nxt_unit_request_info_impl_t *nxt_unit_request_info_get(nxt_unit_ctx_t *ctx)
{
    ...
    if (nxt_queue_is_empty(&ctx_impl->free_req))
    {
        ...
        req_impl = nxt_unit_malloc(ctx, sizeof(nxt_unit_request_info_impl_t) + lib->request_data_size);
        if (nxt_slow_path(req_impl == NULL))
        {
            return NULL;
        }
...
static void nxt_unit_websocket_frame_free(nxt_unit_ctx_t *ctx, nxt_unit_websocket_frame_impl_t *ws_impl)
{
    ...
    for (i = 0; i < r->fields_count; i++)
    {
        ...
        case NXT_UNIT_HASH_CONTENT_LENGTH:
            if (fields[i].name_length == content_length.length &&
                nxt_unit_memcasecmp(name, content_length.start, content_length.length) == 0)
            {
        ...
        case NXT_UNIT_HASH_CONTENT_TYPE:
            if (fields[i].name_length == content_type.length &&
                nxt_unit_memcasecmp(name, content_type.start, content_type.length) == 0)
            {
        ...
        case NXT_UNIT_HASH_COOKIE:
            if (fields[i].name_length == cookie.length && nxt_unit_memcasecmp(name, cookie.start, cookie.length) == 0)
            {
                r->cookie_field = i;
            }
        ...
        {
            if (fields[i].hash != fields[j].hash || fields[i].name_length != fields[j].name_length ||
                nxt_unit_memcasecmp(name, nxt_unit_sptr_get(&fields[j].name), fields[j].name_length) != 0)
            {
                continue;
            }
...
int nxt_unit_response_init(nxt_unit_request_info_t *req, uint16_t status, uint32_t max_fields_count,
                           uint32_t max_fields_size)
{
    ...
    nxt_unit_req_debug(req, "init: %d, max fields %d/%d", (int)status, (int)max_fields_count, (int)max_fields_size);
     ...
     */
    buf_size = sizeof(nxt_unit_response_t) + max_fields_count * (sizeof(nxt_unit_field_t) + 2) + max_fields_size;
...
init_response:
    ...
    buf->free = buf->start + sizeof(nxt_unit_response_t) + max_fields_count * sizeof(nxt_unit_field_t);
...
int nxt_unit_response_realloc(nxt_unit_request_info_t *req, uint32_t max_fields_count, uint32_t max_fields_size)
{
    char *p;
    uint32_t i, buf_size;
    nxt_unit_buf_t *buf;
    ...
    p = buf->start + sizeof(nxt_unit_response_t) + max_fields_count * sizeof(nxt_unit_field_t);
    f = resp->fields;
    ...
    for (i = 0; i < req->response->fields_count; i++)
    {
        ...
        if (nxt_slow_path(src->name_length + src->value_length + 2 > (uint32_t)(buf->end - p)))
        {
    ...
    {
        if (nxt_slow_path(req->response->piggyback_content_length > (uint32_t)(buf->end - p)))
        {
            nxt_unit_req_warn(req,
...
int nxt_unit_response_add_field(nxt_unit_request_info_t *req, const char *name, uint8_t name_length, const char *value,
                                uint32_t value_length)
{
    ...
    {
        nxt_unit_req_warn(req, "add_field: too many response fields (%d)", (int)resp->fields_count);
    ...
    if (nxt_slow_path(name_length + value_length + 2 > (uint32_t)(buf->end - buf->free)))
    {
    ...
    nxt_unit_req_debug(req, "add_field #%" PRIu32 ": %.*s: %.*s", resp->fields_count, (int)name_length, name,
...
int nxt_unit_response_send(nxt_unit_request_info_t *req)
{
    ...
    nxt_unit_req_debug(req, "send: %" PRIu32 " fields, %d bytes", req->response->fields_count,
...
nxt_unit_buf_t *nxt_unit_response_buf_alloc(nxt_unit_request_info_t *req, uint32_t size)
{
    ...
    rc = nxt_unit_get_outgoing_buf(req->ctx, req->response_port, size, size, mmap_buf, NULL);
    if (nxt_slow_path(rc != NXT_UNIT_OK))
    {
...
int nxt_unit_buf_send(nxt_unit_buf_t *buf)
{
    ...
    nxt_unit_req_debug(req, "buf_send: %d bytes", (int)(buf->free - buf->start));
...
static void nxt_unit_buf_send_done(nxt_unit_buf_t *buf)
{
    int rc;
    nxt_unit_mmap_buf_t *mmap_buf;
    nxt_unit_request_info_t *req;
...
static int nxt_unit_mmap_buf_send(nxt_unit_request_info_t *req, nxt_unit_mmap_buf_t *mmap_buf, int last)
{
    ...
    if (m.msg.mmap)
    {
        ...
        nxt_unit_debug(req->ctx, "#%" PRIu32 ": send mmap: (%d,%d,%d)", req_impl->stream, (int)m.mmap_msg.mmap_id,
                       (int)m.mmap_msg.chunk_id, (int)m.mmap_msg.size);

        res = nxt_unit_port_send(req->ctx, req->response_port, &m, sizeof(m), NULL);
        ...
        nxt_atomic_fetch_add(&lib->outgoing.allocated_chunks, (int)m.mmap_msg.chunk_id - (int)first_free_chunk);

        nxt_unit_debug(req->ctx, "allocated_chunks %d", (int)lib->outgoing.allocated_chunks);
    }
    else
    {
        if (nxt_slow_path(mmap_buf->plain_ptr == NULL || mmap_buf->plain_ptr > buf->start - sizeof(m.msg)))
        {
        ...
        nxt_unit_debug(req->ctx, "#%" PRIu32 ": send plain: %d", req_impl->stream,
                       (int)(sizeof(m.msg) + m.mmap_msg.size));

        res = nxt_unit_port_send(req->ctx, req->response_port, buf->start - sizeof(m.msg),
...
static void nxt_unit_free_outgoing_buf(nxt_unit_mmap_buf_t *mmap_buf)
{
    ...
    {
        nxt_unit_mmap_release(&mmap_buf->ctx_impl->ctx, mmap_buf->hdr, mmap_buf->buf.start,
...
ssize_t nxt_unit_response_write_nb(nxt_unit_request_info_t *req, const void *start, size_t size, size_t min_size)
{
    int rc;
    ssize_t sent;
    ...
    while (size > 0)
    {
        ...
        rc = nxt_unit_get_outgoing_buf(req->ctx, req->response_port, part_size, min_part_size, &mmap_buf, local_buf);
        if (nxt_slow_path(rc != NXT_UNIT_OK))
        {
            return -rc;
        }
        ...
        mmap_buf.buf.free = nxt_cpymem(mmap_buf.buf.free, part_start, part_size);
...
int nxt_unit_response_write_cb(nxt_unit_request_info_t *req, nxt_unit_read_info_t *read_info)
{
    ...
    while (!read_info->eof)
    {
        nxt_unit_req_debug(req, "write_cb, alloc %" PRIu32 "", read_info->buf_size);

        buf_size = nxt_min(read_info->buf_size, PORT_MMAP_DATA_SIZE);

        rc = nxt_unit_get_outgoing_buf(req->ctx, req->response_port, buf_size, buf_size, &mmap_buf, local_buf);
        if (nxt_slow_path(rc != NXT_UNIT_OK))
        {
            return rc;
        }
...
ssize_t nxt_unit_request_read(nxt_unit_request_info_t *req, void *dst, size_t size)
{
    ...
    buf_res = nxt_unit_buf_read(&req->content_buf, &req->content_length, dst, size);
    ...
    if (buf_res < (ssize_t)size && req->content_fd != -1)
    {
        ...
        {
            nxt_unit_req_alert(req, "failed to read content: %s (%d)", strerror(errno), errno);
...
ssize_t nxt_unit_request_readline_size(nxt_unit_request_info_t *req, size_t max_size)
{
    ...
    while (b != NULL)
    {
        ...
        if (mmap_buf->next == NULL && req->content_fd != -1 && l_size < req->content_length)
        {
...
void nxt_unit_request_done(nxt_unit_request_info_t *req, int rc)
{
    ...
    if (nxt_slow_path(req_impl->state < NXT_UNIT_RS_RESPONSE_INIT))
    {
        ...
        rc = nxt_unit_response_add_field(req, "Content-Type", nxt_length("Content-Type"), "text/plain",
...
skip_response_send:
    ...
    msg.pid = lib->pid;
    msg.reply_port = 0;
    msg.type = (rc == NXT_UNIT_OK) ? _NXT_PORT_MSG_DATA : _NXT_PORT_MSG_RPC_ERROR;
    msg.last = 1;
    msg.mmap = 0;
    msg.nf = 0;
    msg.mf = 0;

    (void)nxt_unit_port_send(req->ctx, req->response_port, &msg, sizeof(msg), NULL);

    nxt_unit_request_info_release(req);
}

int nxt_unit_websocket_send(nxt_unit_request_info_t *req, uint8_t opcode, uint8_t last, const void *start, size_t size)
{
...
int nxt_unit_websocket_sendv(nxt_unit_request_info_t *req, uint8_t opcode, uint8_t last, const struct iovec *iov,
                             int iovcnt)
{
    int i, rc;
    size_t l, copy;
    ...
    rc = nxt_unit_get_outgoing_buf(req->ctx, req->response_port, alloc_size, alloc_size, &mmap_buf, local_buf);
    if (nxt_slow_path(rc != NXT_UNIT_OK))
    {
        return rc;
    }
    ...
    for (i = 0; i < iovcnt; i++)
    {
        ...
        while (l > 0)
        {
            ...
            if (l > 0)
            {
                ...
                rc = nxt_unit_get_outgoing_buf(req->ctx, req->response_port, alloc_size, alloc_size, &mmap_buf,
                                               local_buf);
                if (nxt_slow_path(rc != NXT_UNIT_OK))
                {
                    return rc;
...
retry:
    ...
    for (mm = lib->outgoing.elts; mm < mm_end; mm++)
    {
        ...
        if (hdr->sent_over != 0xFFFFu && (hdr->sent_over != port->id.id || mm->src_thread != pthread_self()))
        {
            continue;
        }
        ...
        *c = 0;
        ...
        while (nxt_port_mmap_get_free_chunk(hdr->free_map, c))
        {
            ...
            while (nchunks < *n)
            {
                res = nxt_port_mmap_chk_set_chunk_busy(hdr->free_map, *c + nchunks);
    ...
    if (outgoing_size >= lib->shm_mmap_limit)
    {
        ...
        if (nxt_slow_path(lib->outgoing.allocated_chunks + min_n >= lib->shm_mmap_limit * PORT_MMAP_CHUNK_COUNT))
        {
...
unlock:
    ...
    nxt_unit_debug(ctx, "allocated_chunks %d", (int)lib->outgoing.allocated_chunks);
...
static nxt_port_mmap_header_t *nxt_unit_new_mmap(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, int n)
{
    ...
    if (nxt_slow_path(mem == MAP_FAILED))
    {
        nxt_unit_alert(ctx, "mmap(%d) failed: %s (%d)", fd, strerror(errno), errno);
    ...
    {
        nxt_unit_debug(ctx, "new mmap #%" PRIu32 " created for %d -> %d", hdr->id, (int)lib->pid, (int)port->id.pid);
    }
...
static int nxt_unit_shm_open(nxt_unit_ctx_t *ctx, size_t size)
{
    ...
    lib = nxt_container_of(ctx->unit, nxt_unit_impl_t, unit);
    snprintf(name, sizeof(name), NXT_SHM_PREFIX "unit.%d.%p", lib->pid, (void *)(uintptr_t)pthread_self());
#endif
    ...
    if (nxt_slow_path(fd == -1))
    {
        nxt_unit_alert(ctx, "memfd_create(%s) failed: %s (%d)", name, strerror(errno), errno);
    ...
    if (nxt_slow_path(fd == -1))
    {
        nxt_unit_alert(ctx, "shm_open(SHM_ANON) failed: %s (%d)", strerror(errno), errno);
    ...
    if (nxt_slow_path(fd == -1))
    {
        nxt_unit_alert(ctx, "shm_open(%s) failed: %s (%d)", name, strerror(errno), errno);
    ...
    {
        nxt_unit_alert(ctx, "shm_unlink(%s) failed: %s (%d)", name, strerror(errno), errno);
    }
...
#error No working shared memory implementation.
    ...
    {
        nxt_unit_alert(ctx, "ftruncate(%d) failed: %s (%d)", fd, strerror(errno), errno);
                                     ...
                                     nxt_unit_mmap_buf_t *mmap_buf, char *local_buf)
{
    ...
    if (size <= NXT_UNIT_MAX_PLAIN_SIZE)
    {
        ...
        {
            mmap_buf->free_ptr = nxt_unit_malloc(ctx, size + sizeof(nxt_port_msg_t));
            if (nxt_slow_path(mmap_buf->free_ptr == NULL))
            {
                return NXT_UNIT_ERROR;
            }
        ...
        nxt_unit_debug(ctx, "outgoing plain buffer allocation: (%p, %d)", mmap_buf->buf.start, (int)size);
    ...
    nxt_unit_debug(ctx, "outgoing mmap allocation: (%d,%d,%d)", (int)hdr->id, (int)c,
...
static int nxt_unit_incoming_mmap(nxt_unit_ctx_t *ctx, pid_t pid, int fd)
{
    ...
    {
        nxt_unit_alert(ctx, "incoming_mmap: fstat(%d) failed: %s (%d)", fd, strerror(errno), errno);

        return NXT_UNIT_ERROR;
    }

    mem = mmap(NULL, mmap_stat.st_size, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0);
    if (nxt_slow_path(mem == MAP_FAILED))
    {
        nxt_unit_alert(ctx, "incoming_mmap: mmap() failed: %s (%d)", strerror(errno), errno);
    ...
    if (nxt_slow_path(hdr->src_pid != pid))
    {
        ...
        nxt_unit_alert(ctx,
                       ...
                       "detected: %d != %d or %d != %d",
                       (int)hdr->src_pid, (int)pid, (int)hdr->dst_pid, (int)lib->pid);
...
static void nxt_unit_awake_ctx(nxt_unit_ctx_t *ctx, nxt_unit_ctx_impl_t *ctx_impl)
{
    ...
    if (nxt_slow_path(ctx_impl->read_port == NULL || ctx_impl->read_port->out_fd == -1))
    {
    ...
    (void)nxt_unit_port_send(ctx, ctx_impl->read_port, &msg, sizeof(msg), NULL);
}
...
static int nxt_unit_mmap_read(nxt_unit_ctx_t *ctx, nxt_unit_recv_msg_t *recv_msg, nxt_unit_read_buf_t *rbuf)
{
    ...
    {
        nxt_unit_warn(ctx, "#%" PRIu32 ": mmap_read: too small message (%d)", recv_msg->stream, (int)recv_msg->size);
    ...
    for (; mmap_msg < end; mmap_msg++)
    {
        ...
        if (nxt_slow_path(b == NULL))
        {
            nxt_unit_warn(ctx, "#%" PRIu32 ": mmap_read: failed to allocate buf", recv_msg->stream);
    ...
    for (; mmap_msg < end; mmap_msg++)
    {
        res = nxt_unit_check_rbuf_mmap(ctx, mmaps, recv_msg->pid, mmap_msg->mmap_id, &hdr, rbuf);
        ...
        nxt_unit_debug(ctx, "#%" PRIu32 ": mmap_read: [%p,%d] %d->%d,(%d,%d,%d)", recv_msg->stream, start, (int)size,
                       (int)hdr->src_pid, (int)hdr->dst_pid, (int)hdr->id, (int)mmap_msg->chunk_id,
                       (int)mmap_msg->size);
    }
...
static void nxt_unit_mmap_release(nxt_unit_ctx_t *ctx, nxt_port_mmap_header_t *hdr, void *start, uint32_t size)
{
    ...
    if (hdr->dst_pid == lib->pid && freed_chunks != 0 && nxt_atomic_cmp_set(&hdr->oosm, 1, 0))
    {
...
static nxt_int_t nxt_unit_lvlhsh_pid_test(nxt_lvlhsh_query_t *lhq, void *data)
{
    nxt_process_t *process;

    process = data;

    if (lhq->key.length == sizeof(pid_t) && *(pid_t *)lhq->key.start == process->pid)
    {
        return NXT_OK;
    }
...
static inline void nxt_unit_process_lhq_pid(nxt_lvlhsh_query_t *lhq, pid_t *pid)
{
...
static int nxt_unit_read_buf(nxt_unit_ctx_t *ctx, nxt_unit_read_buf_t *rbuf)
{
    ...
    port_impl = nxt_container_of(ctx_impl->read_port, nxt_unit_port_impl_t, port);
...
retry:
    ...
    if (port_impl->from_socket == 0)
    {
        ...
        if (res == NXT_UNIT_OK)
        {
            if (nxt_unit_is_read_socket(rbuf))
            {
                ...
                nxt_unit_debug(ctx, "port{%d,%d} dequeue 1 read_socket %d", (int)ctx_impl->read_port->id.pid,
                               (int)ctx_impl->read_port->id.id, port_impl->from_socket);
            }
            else
            {
                nxt_unit_debug(ctx, "port{%d,%d} dequeue %d", (int)ctx_impl->read_port->id.pid,
                               (int)ctx_impl->read_port->id.id, (int)rbuf->size);
    ...
    nxt_unit_debug(ctx, "poll(%d,%d): %d, revents [%04X, %04X]", fds[0].fd, fds[1].fd, nevents, fds[0].revents,
                   fds[1].revents);
    ...
    nxt_unit_alert(ctx, "poll(%d,%d): %d unexpected revents [%04uXi, %04uXi]", fds[0].fd, fds[1].fd, nevents,
...
static int nxt_unit_chk_ready(nxt_unit_ctx_t *ctx)
{
    ...
    return (ctx_impl->ready && (lib->request_limit == 0 || lib->request_count < lib->request_limit));
}
...
static void nxt_unit_process_ready_req(nxt_unit_ctx_t *ctx)
{
    ...
    nxt_queue_each(req_impl, &ready_req, nxt_unit_request_info_impl_t, port_wait_link)
    {
...
nxt_unit_ctx_t *nxt_unit_ctx_alloc(nxt_unit_ctx_t *ctx, void *data)
{
    int rc, queue_fd;
    void *mem;
    nxt_unit_impl_t *lib;
    ...
    new_ctx = nxt_unit_malloc(ctx, sizeof(nxt_unit_ctx_impl_t) + lib->request_data_size);
...
static void nxt_unit_ctx_free(nxt_unit_ctx_impl_t *ctx_impl)
{
    ...
    nxt_queue_each(req_impl, &ctx_impl->active_req, nxt_unit_request_info_impl_t, link)
    {
    ...
    nxt_queue_each(req_impl, &ctx_impl->free_req, nxt_unit_request_info_impl_t, link)
    {
        nxt_unit_request_info_free(req_impl);
    }
    nxt_queue_loop;

    nxt_queue_each(ws_impl, &ctx_impl->free_ws, nxt_unit_websocket_frame_impl_t, link)
    {
...
static nxt_unit_port_t *nxt_unit_create_port(nxt_unit_ctx_t *ctx)
{
    ...
    if (nxt_slow_path(rc != 0))
    {
        nxt_unit_warn(ctx, "create_port: socketpair() failed: %s (%d)", strerror(errno), errno);
    ...
    if (nxt_slow_path(setsockopt(port_sockets[0], SOL_SOCKET, SO_PASSCRED, &enable_creds, sizeof(enable_creds)) == -1))
    {
        nxt_unit_warn(ctx, "failed to set SO_PASSCRED %s", strerror(errno));
        return NULL;
    }

    if (nxt_slow_path(setsockopt(port_sockets[1], SOL_SOCKET, SO_PASSCRED, &enable_creds, sizeof(enable_creds)) == -1))
    {
        nxt_unit_warn(ctx, "failed to set SO_PASSCRED %s", strerror(errno));
        return NULL;
    }
    ...
    nxt_unit_debug(ctx, "create_port: new socketpair: %d->%d", port_sockets[0], port_sockets[1]);
...
nxt_inline void nxt_unit_port_release(nxt_unit_port_t *port)
{
    ...
    if (c == 1)
    {
        nxt_unit_debug(NULL, "destroy port{%d,%d} in_fd %d out_fd %d", (int)port->id.pid, (int)port->id.id, port->in_fd,
                       port->out_fd);
        ...
        {
            munmap(port_impl->queue,
                   (port->id.id == NXT_UNIT_SHARED_PORT_ID) ? sizeof(nxt_app_queue_t) : sizeof(nxt_port_queue_t));
        }
...
static nxt_unit_port_t *nxt_unit_add_port(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, void *queue)
{
    ...
    nxt_unit_debug(ctx, "add_port: port{%d,%d} in_fd %d out_fd %d queue %p", port->id.pid, port->id.id, port->in_fd,
                   port->out_fd, queue);
    ...
    if (port->id.id != NXT_UNIT_SHARED_PORT_ID && port->id.id >= process->next_port_id)
    {
    ...
    {
        nxt_unit_alert(ctx, "add_port: %d,%d malloc() failed", port->id.pid, port->id.id);
    ...
    if (nxt_slow_path(rc != NXT_UNIT_OK))
    {
        nxt_unit_alert(ctx, "add_port: %d,%d hash_add failed", port->id.pid, port->id.id);
...
static void nxt_unit_process_awaiting_req(nxt_unit_ctx_t *ctx, nxt_queue_t *awaiting_req)
{
    ...
    nxt_queue_each(req_impl, awaiting_req, nxt_unit_request_info_impl_t, port_wait_link)
    {
...
static nxt_unit_port_t *nxt_unit_remove_port_unsafe(nxt_unit_impl_t *lib, nxt_unit_port_id_t *port_id)
{
    ...
    if (nxt_slow_path(port == NULL))
    {
        nxt_unit_debug(NULL, "remove_port: port{%d,%d} not found", (int)port_id->pid, (int)port_id->id);

        return NULL;
    }

    nxt_unit_debug(NULL, "remove_port: port{%d,%d}, fds %d,%d, data %p", (int)port_id->pid, (int)port_id->id,
...
static void nxt_unit_quit(nxt_unit_ctx_t *ctx, uint8_t quit_param)
{
    ...
    nxt_unit_debug(ctx, "quit: %d/%d/%d", (int)quit_param, ctx_impl->ready, ctx_impl->online);
    ...
    skip_graceful_broadcast = quit_param == NXT_QUIT_GRACEFUL && !ctx_impl->ready;
    ...
    if (quit_param == NXT_QUIT_GRACEFUL)
    {
        ...
        quit = nxt_queue_is_empty(&ctx_impl->active_req) && nxt_queue_is_empty(&ctx_impl->pending_rbuf) &&
               ctx_impl->wait_items == 0;
    ...
    nxt_queue_each(ctx_impl, &lib->contexts, nxt_unit_ctx_impl_t, link)
    {
        ...
        if (ctx == &ctx_impl->ctx || ctx_impl->read_port == NULL || ctx_impl->read_port->out_fd == -1)
        {
            continue;
        }

        (void)nxt_unit_port_send(ctx, ctx_impl->read_port, &m, sizeof(m), NULL);
    }
    nxt_queue_loop;
...
static int nxt_unit_get_port(nxt_unit_ctx_t *ctx, nxt_unit_port_id_t *port_id)
{
    ...
    nxt_unit_debug(ctx, "get_port: %d %d", (int)port_id->pid, (int)port_id->id);
                                  ...
                                  const nxt_send_oob_t *oob)
{
    ...
    port_impl = nxt_container_of(port, nxt_unit_port_impl_t, port);
    if (port_impl->queue != NULL && (oob == NULL || oob->size == 0) && buf_size <= NXT_PORT_QUEUE_MSG_SIZE)
    {
        rc = nxt_port_queue_send(port_impl->queue, buf, buf_size, &notify);
        if (nxt_slow_path(rc != NXT_OK))
        {
            nxt_unit_alert(ctx, "port_send: port %d,%d queue overflow", (int)port->id.pid, (int)port->id.id);

            return -1;
        }

        nxt_unit_debug(ctx, "port{%d,%d} enqueue %d notify %d", (int)port->id.pid, (int)port->id.id, (int)buf_size,
                       notify);
        ...
        if (notify)
        {
            ...
            {
                ret = nxt_unit_sendmsg(ctx, port->out_fd, &msg, sizeof(nxt_port_msg_t), NULL);

                nxt_unit_debug(ctx, "port{%d,%d} send %d read_queue", (int)port->id.pid, (int)port->id.id, (int)ret);
            }
            else
            {
                ret = lib->callbacks.port_send(ctx, port, &msg, sizeof(nxt_port_msg_t), NULL, 0);

                nxt_unit_debug(ctx, "port{%d,%d} sendcb %d read_queue", (int)port->id.pid, (int)port->id.id, (int)ret);
            }
        }
    ...
    if (port_impl->queue != NULL)
    {
        ...
        nxt_unit_debug(ctx, "port{%d,%d} enqueue 1 read_socket notify %d", (int)port->id.pid, (int)port->id.id, notify);
    }

    if (lib->callbacks.port_send != NULL)
    {
        ret = lib->callbacks.port_send(ctx, port, buf, buf_size, oob != NULL ? oob->buf : NULL,
                                       oob != NULL ? oob->size : 0);
...
retry:
    ...
    {
        nxt_unit_debug(ctx, "sendmsg(%d, %d, %d): %d", fd, (int)buf_size, (oob != NULL ? (int)oob->size : 0), (int)n);
    }
...
retry:
    ...
    if (port_impl->from_socket > 0)
    {
        if (port_impl->socket_rbuf != NULL && port_impl->socket_rbuf->size > 0)
        {
            port_impl->from_socket--;
            ...
            nxt_unit_debug(ctx, "port{%d,%d} use suspended message %d", (int)port->id.pid, (int)port->id.id,
                           (int)rbuf->size);
    ...
    else
    {
        ...
        if (res == NXT_UNIT_OK)
        {
            if (nxt_unit_is_read_socket(rbuf))
            {
                ...
                nxt_unit_debug(ctx, "port{%d,%d} dequeue 1 read_socket %d", (int)port->id.pid, (int)port->id.id,
                               port_impl->from_socket);

                goto retry;
            }

            nxt_unit_debug(ctx, "port{%d,%d} dequeue %d", (int)port->id.pid, (int)port->id.id, (int)rbuf->size);
    ...
    {
        nxt_unit_debug(ctx, "port{%d,%d} recv %d read_queue", (int)port->id.pid, (int)port->id.id, (int)rbuf->size);

        goto retry;
    }

    nxt_unit_debug(ctx, "port{%d,%d} recvmsg %d", (int)port->id.pid, (int)port->id.id, (int)rbuf->size);
    ...
    nxt_unit_debug(ctx, "port{%d,%d} suspend message %d", (int)port->id.pid, (int)port->id.id, (int)rbuf->size);
...
static int nxt_unit_port_recv(nxt_unit_ctx_t *ctx, nxt_unit_port_t *port, nxt_unit_read_buf_t *rbuf)
{
    ...
    if (lib->callbacks.port_recv != NULL)
    {
        ...
        rbuf->size = lib->callbacks.port_recv(ctx, port, rbuf->buf, sizeof(rbuf->buf), rbuf->oob.buf, &oob_size);

        nxt_unit_debug(ctx, "port{%d,%d} recvcb %d", (int)port->id.pid, (int)port->id.id, (int)rbuf->size);
        ...
        if (nxt_app_queue_cancel(queue, cookie, port_msg->stream))
        {
            ...
            if (lib->request_limit != 0)
            {
                ...
                if (nxt_slow_path(lib->request_count >= lib->request_limit))
                {
                    ...
                    (void)nxt_unit_port_send(ctx, lib->main_ctx.read_port, &m, sizeof(m), NULL);
                }
            }
...
nxt_inline int nxt_unit_close(int fd)
{
    ...
    {
        nxt_unit_alert(NULL, "close(%d) failed: %s (%d)", fd, strerror(errno), errno);
    }
    else
    {
...
static int nxt_unit_fd_blocking(int fd)
{
    ...
    {
        nxt_unit_alert(NULL, "ioctl(%d, FIONBIO, 0) failed: %s (%d)", fd, strerror(errno), errno);
...
static nxt_int_t nxt_unit_port_hash_test(nxt_lvlhsh_query_t *lhq, void *data)
{
    nxt_unit_port_t *port;
    ...
    if (lhq->key.length == sizeof(nxt_unit_port_hash_id_t) && port_id->pid == port->id.pid &&
...
static inline void nxt_unit_port_hash_lhq(nxt_lvlhsh_query_t *lhq, nxt_unit_port_hash_id_t *port_hash_id,
                                          nxt_unit_port_id_t *port_id)
{
    ...
    else
    {
        ...
        nxt_unit_debug(NULL, "calculate hash for port_id (%d, %d): %04X", (int)port_id->pid, (int)port_id->id,
                       (int)port_id->hash);
    }
...
static nxt_int_t nxt_unit_request_hash_test(nxt_lvlhsh_query_t *lhq, void *data)
{
    return NXT_OK;
}
...
static nxt_unit_request_info_t *nxt_unit_request_hash_find(nxt_unit_ctx_t *ctx, uint32_t stream, int remove)
{
    ...
    case NXT_OK:
        req_impl = nxt_container_of(lhq.value, nxt_unit_request_info_impl_t, req);
        if (remove)
        {
            req_impl->in_hash = 0;
        }
...
#if (NXT_DEBUG)
    p += snprintf(p, end - p, "%4d/%02d/%02d %02d:%02d:%02d.%03d ", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday,
                  tm.tm_hour, tm.tm_min, tm.tm_sec, (int)ts.tv_nsec / 1000000);
#else
    p += snprintf(p, end - p, "%4d/%02d/%02d %02d:%02d:%02d ", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour,
                  tm.tm_min, tm.tm_sec);
#endif

    p += snprintf(p, end - p, "[%s] %d#%" PRIu64 " [unit] ", nxt_unit_log_levels[level], (int)pid,
...
static void *nxt_unit_lvlhsh_alloc(void *data, size_t size)
{
    ...
    {
        nxt_unit_debug(NULL, "posix_memalign(%d, %d): %p", (int)size, (int)size, p);
        return p;
    }
...
void *nxt_unit_malloc(nxt_unit_ctx_t *ctx, size_t size)
{
    ...
    {
        nxt_unit_alert(ctx, "malloc(%d) failed: %s (%d)", (int)size, strerror(errno), errno);
    }
