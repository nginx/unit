...
nxt_int_t nxt_http_response_status(void *ctx, nxt_http_field_t *field,
                                   uintptr_t data) {
  nxt_int_t status;
...
nxt_int_t nxt_http_response_skip(void *ctx, nxt_http_field_t *field,
                                 uintptr_t data) {
  field->skip = 1;
...
nxt_int_t nxt_http_response_field(void *ctx, nxt_http_field_t *field,
                                  uintptr_t offset) {
  nxt_http_request_t *r;
