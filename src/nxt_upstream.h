...
typedef struct nxt_upstream_round_robin_server_s nxt_upstream_round_robin_server_t;
...
typedef nxt_upstream_t *(*nxt_upstream_joint_create_t)(nxt_router_temp_conf_t *tmcf, nxt_upstream_t *upstream);
