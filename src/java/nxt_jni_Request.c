...
static void JNICALL nxt_java_Request_log (JNIEnv *env, jclass cls,
                                          jlong req_info_ptr, jstring msg,
                                          jint msg_len);
...
static void JNICALL nxt_java_Request_sendWsFrameBuf (JNIEnv *env, jclass cls,
                                                     jlong req_info_ptr,
                                                     jobject buf, jint pos,
                                                     jint len, jbyte opCode,
                                                     jboolean last);
...
nxt_java_initRequest (JNIEnv *env, jobject cl)
{
  ...
  res = (*env)->RegisterNatives (env, nxt_java_Request_class, request_methods,
                                 sizeof (request_methods)
                                     / sizeof (request_methods[0]));
...
static void JNICALL
nxt_java_Request_trace (JNIEnv *env, jclass cls, jlong req_info_ptr,
                        jstring msg, jint msg_len)
{
#if (NXT_DEBUG)
  const char *msg_str;
  nxt_unit_request_info_t *req;
...
static void JNICALL
nxt_java_Request_sendWsFrameBuf (JNIEnv *env, jclass cls, jlong req_info_ptr,
                                 jobject buf, jint pos, jint len, jbyte opCode,
                                 jboolean last)
{
  nxt_unit_request_info_t *req;
...
static void JNICALL
nxt_java_Request_sendWsFrameArr (JNIEnv *env, jclass cls, jlong req_info_ptr,
                                 jarray arr, jint pos, jint len, jbyte opCode,
                                 jboolean last)
{
  nxt_unit_request_info_t *req;
