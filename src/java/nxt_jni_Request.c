...
static jstring JNICALL nxt_java_Request_getHeader(JNIEnv *env, jclass cls, jlong req_ptr, jstring name, jint name_len);
static jobject JNICALL nxt_java_Request_getHeaderNames(JNIEnv *env, jclass cls, jlong req_ptr);
static jobject JNICALL nxt_java_Request_getHeaders(JNIEnv *env, jclass cls, jlong req_ptr, jstring name, jint name_len);
static jint JNICALL nxt_java_Request_getIntHeader(JNIEnv *env, jclass cls, jlong req_ptr, jstring name, jint name_len);
static jstring JNICALL nxt_java_Request_getMethod(JNIEnv *env, jclass cls, jlong req_ptr);
static jstring JNICALL nxt_java_Request_getQueryString(JNIEnv *env, jclass cls, jlong req_ptr);
...
static void JNICALL nxt_java_Request_upgrade(JNIEnv *env, jclass cls, jlong req_info_ptr);
static jboolean JNICALL nxt_java_Request_isUpgrade(JNIEnv *env, jclass cls, jlong req_info_ptr);
static void JNICALL nxt_java_Request_log(JNIEnv *env, jclass cls, jlong req_info_ptr, jstring msg, jint msg_len);
static void JNICALL nxt_java_Request_trace(JNIEnv *env, jclass cls, jlong req_info_ptr, jstring msg, jint msg_len);
static jobject JNICALL nxt_java_Request_getResponse(JNIEnv *env, jclass cls, jlong req_info_ptr);
static void JNICALL nxt_java_Request_sendWsFrameBuf(JNIEnv *env, jclass cls, jlong req_info_ptr, jobject buf, jint pos,
                                                    jint len, jbyte opCode, jboolean last);
static void JNICALL nxt_java_Request_sendWsFrameArr(JNIEnv *env, jclass cls, jlong req_info_ptr, jarray arr, jint pos,
                                                    jint len, jbyte opCode, jboolean last);
static void JNICALL nxt_java_Request_closeWs(JNIEnv *env, jclass cls, jlong req_info_ptr);
...
int nxt_java_initRequest(JNIEnv *env, jobject cl)
{
    ...
    JNINativeMethod request_methods[] = {
        {(char *)"getHeader", (char *)"(JLjava/lang/String;I)Ljava/lang/String;", nxt_java_Request_getHeader},

        {(char *)"getHeaderNames", (char *)"(J)Ljava/util/Enumeration;", nxt_java_Request_getHeaderNames},

        {(char *)"getHeaders", (char *)"(JLjava/lang/String;I)Ljava/util/Enumeration;", nxt_java_Request_getHeaders},

        {(char *)"getIntHeader", (char *)"(JLjava/lang/String;I)I", nxt_java_Request_getIntHeader},

        {(char *)"getMethod", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getMethod},

        {(char *)"getQueryString", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getQueryString},

        {(char *)"getRequestURI", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getRequestURI},

        {(char *)"getContentLength", (char *)"(J)J", nxt_java_Request_getContentLength},

        {(char *)"getContentType", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getContentType},

        {(char *)"getLocalAddr", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getLocalAddr},

        {(char *)"getLocalName", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getLocalName},

        {(char *)"getLocalPort", (char *)"(J)I", nxt_java_Request_getLocalPort},

        {(char *)"getProtocol", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getProtocol},

        {(char *)"getRemoteAddr", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getRemoteAddr},

        {(char *)"getRemoteHost", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getRemoteHost},

        {(char *)"getRemotePort", (char *)"(J)I", nxt_java_Request_getRemotePort},

        {(char *)"getScheme", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getScheme},

        {(char *)"getServerName", (char *)"(J)Ljava/lang/String;", nxt_java_Request_getServerName},

        {(char *)"getServerPort", (char *)"(J)I", nxt_java_Request_getServerPort},

        {(char *)"isSecure", (char *)"(J)Z", nxt_java_Request_isSecure},

        {(char *)"upgrade", (char *)"(J)V", nxt_java_Request_upgrade},

        {(char *)"isUpgrade", (char *)"(J)Z", nxt_java_Request_isUpgrade},

        {(char *)"log", (char *)"(JLjava/lang/String;I)V", nxt_java_Request_log},

        {(char *)"trace", (char *)"(JLjava/lang/String;I)V", nxt_java_Request_trace},

        {(char *)"getResponse", (char *)"(J)Lnginx/unit/Response;", nxt_java_Request_getResponse},

        {(char *)"sendWsFrame", (char *)"(JLjava/nio/ByteBuffer;IIBZ)V", nxt_java_Request_sendWsFrameBuf},

        {(char *)"sendWsFrame", (char *)"(J[BIIBZ)V", nxt_java_Request_sendWsFrameArr},

        {(char *)"closeWs", (char *)"(J)V", nxt_java_Request_closeWs},

    };

    res = (*env)->RegisterNatives(env, nxt_java_Request_class, request_methods,
...
{
    return (*env)->NewObject(env, nxt_java_Request_class, nxt_java_Request_ctor, ctx, nxt_ptr2jlong(req),
...
static jstring JNICALL nxt_java_Request_getHeader(JNIEnv *env, jclass cls, jlong req_ptr, jstring name, jint name_len)
{
    ...
    f = nxt_java_findHeader(r->fields, r->fields + r->fields_count, name_str, name_len);
...
static jobject JNICALL nxt_java_Request_getHeaders(JNIEnv *env, jclass cls, jlong req_ptr, jstring name, jint name_len)
{
    ...
    return nxt_java_newHeadersEnumeration(env, r->fields, r->fields_count, f - r->fields);
}
...
static jstring JNICALL nxt_java_Request_getLocalAddr(JNIEnv *env, jclass cls, jlong req_ptr)
{
    ...
    return nxt_java_newString(env, nxt_unit_sptr_get(&r->local_addr), r->local_addr_length);
}
...
static jstring JNICALL nxt_java_Request_getRemoteAddr(JNIEnv *env, jclass cls, jlong req_ptr)
{
    ...
    return nxt_java_newString(env, nxt_unit_sptr_get(&r->remote), r->remote_length);
}
...
static jstring JNICALL nxt_java_Request_getServerName(JNIEnv *env, jclass cls, jlong req_ptr)
{
    ...
    f = nxt_java_findHeader(r->fields, r->fields + r->fields_count, "Host", 4);
    if (f != NULL)
    {
...
void nxt_java_Request_websocket(JNIEnv *env, jobject jreq, jobject jbuf, uint8_t opcode, uint8_t fin)
{
