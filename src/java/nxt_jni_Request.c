...
static jstring JNICALL nxt_java_Request_getHeader(JNIEnv* env,
                                                  jclass cls,
                                                  jlong req_ptr,
                                                  jstring name,
                                                  jint name_len);
static jobject JNICALL nxt_java_Request_getHeaderNames(JNIEnv* env,
                                                       jclass cls,
                                                       jlong req_ptr);
static jobject JNICALL nxt_java_Request_getHeaders(JNIEnv* env,
                                                   jclass cls,
                                                   jlong req_ptr,
                                                   jstring name,
                                                   jint name_len);
static jint JNICALL nxt_java_Request_getIntHeader(JNIEnv* env,
                                                  jclass cls,
                                                  jlong req_ptr,
                                                  jstring name,
                                                  jint name_len);
static jstring JNICALL nxt_java_Request_getMethod(JNIEnv* env,
                                                  jclass cls,
                                                  jlong req_ptr);
static jstring JNICALL nxt_java_Request_getQueryString(JNIEnv* env,
                                                       jclass cls,
                                                       jlong req_ptr);
static jstring JNICALL nxt_java_Request_getRequestURI(JNIEnv* env,
                                                      jclass cls,
                                                      jlong req_ptr);
static jlong JNICALL nxt_java_Request_getContentLength(JNIEnv* env,
                                                       jclass cls,
                                                       jlong req_ptr);
static jstring JNICALL nxt_java_Request_getContentType(JNIEnv* env,
                                                       jclass cls,
                                                       jlong req_ptr);
static jstring JNICALL nxt_java_Request_getLocalAddr(JNIEnv* env,
                                                     jclass cls,
                                                     jlong req_ptr);
static jstring JNICALL nxt_java_Request_getLocalName(JNIEnv* env,
                                                     jclass cls,
                                                     jlong req_ptr);
static jint JNICALL nxt_java_Request_getLocalPort(JNIEnv* env,
                                                  jclass cls,
                                                  jlong req_ptr);
static jstring JNICALL nxt_java_Request_getProtocol(JNIEnv* env,
                                                    jclass cls,
                                                    jlong req_ptr);
static jstring JNICALL nxt_java_Request_getRemoteAddr(JNIEnv* env,
                                                      jclass cls,
                                                      jlong req_ptr);
static jstring JNICALL nxt_java_Request_getRemoteHost(JNIEnv* env,
                                                      jclass cls,
                                                      jlong req_ptr);
static jint JNICALL nxt_java_Request_getRemotePort(JNIEnv* env,
                                                   jclass cls,
                                                   jlong req_ptr);
static jstring JNICALL nxt_java_Request_getScheme(JNIEnv* env,
                                                  jclass cls,
                                                  jlong req_ptr);
static jstring JNICALL nxt_java_Request_getServerName(JNIEnv* env,
                                                      jclass cls,
                                                      jlong req_ptr);
static jint JNICALL nxt_java_Request_getServerPort(JNIEnv* env,
                                                   jclass cls,
                                                   jlong req_ptr);
static jboolean JNICALL nxt_java_Request_isSecure(JNIEnv* env,
                                                  jclass cls,
                                                  jlong req_ptr);
static void JNICALL nxt_java_Request_upgrade(JNIEnv* env,
                                             jclass cls,
                                             jlong req_info_ptr);
static jboolean JNICALL nxt_java_Request_isUpgrade(JNIEnv* env,
                                                   jclass cls,
                                                   jlong req_info_ptr);
static void JNICALL nxt_java_Request_log(JNIEnv* env,
                                         jclass cls,
                                         jlong req_info_ptr,
                                         jstring msg,
                                         jint msg_len);
static void JNICALL nxt_java_Request_trace(JNIEnv* env,
                                           jclass cls,
                                           jlong req_info_ptr,
                                           jstring msg,
                                           jint msg_len);
static jobject JNICALL nxt_java_Request_getResponse(JNIEnv* env,
                                                    jclass cls,
                                                    jlong req_info_ptr);
static void JNICALL nxt_java_Request_sendWsFrameBuf(JNIEnv* env,
                                                    jclass cls,
                                                    jlong req_info_ptr,
                                                    jobject buf,
                                                    jint pos,
                                                    ...
                                                    jbyte opCode,
                                                    jboolean last);
static void JNICALL nxt_java_Request_sendWsFrameArr(JNIEnv* env,
                                                    jclass cls,
                                                    jlong req_info_ptr,
                                                    jarray arr,
                                                    jint pos,
                                                    ...
                                                    jbyte opCode,
                                                    jboolean last);
static void JNICALL nxt_java_Request_closeWs(JNIEnv* env,
                                             jclass cls,
                                             jlong req_info_ptr);
...
int nxt_java_initRequest(JNIEnv* env, jobject cl) {
  ...
  nxt_java_Request_ctor =
      (*env)->GetMethodID(env, cls, "<init>", "(Lnginx/unit/Context;JJ)V");
  if (nxt_java_Request_ctor == NULL) {
    (*env)->DeleteGlobalRef(env, cls);
    return NXT_UNIT_ERROR;
  }

  nxt_java_Request_processWsFrame = (*env)->GetMethodID(
      env, cls, "processWsFrame", "(Ljava/nio/ByteBuffer;BZ)V");
  if (nxt_java_Request_processWsFrame == NULL) {
    (*env)->DeleteGlobalRef(env, cls);
    return NXT_UNIT_ERROR;
  }

  nxt_java_Request_closeWsSession =
      (*env)->GetMethodID(env, cls, "closeWsSession", "()V");
  ...
  JNINativeMethod request_methods[] = {
      {(char*)"getHeader", (char*)"(JLjava/lang/String;I)Ljava/lang/String;",
      ...
      {(char*)"getResponse", (char*)"(J)Lnginx/unit/Response;",
       nxt_java_Request_getResponse},

      {(char*)"sendWsFrame", (char*)"(JLjava/nio/ByteBuffer;IIBZ)V",
       nxt_java_Request_sendWsFrameBuf},

      {(char*)"sendWsFrame", (char*)"(J[BIIBZ)V",
  ...
  res = (*env)->RegisterNatives(
      env, nxt_java_Request_class, request_methods,
...
jobject nxt_java_newRequest(JNIEnv* env,
                            jobject ctx,
                            nxt_unit_request_info_t* req) {
  return (*env)->NewObject(env, nxt_java_Request_class, nxt_java_Request_ctor,
                           ctx, nxt_ptr2jlong(req),
...
static jstring JNICALL nxt_java_Request_getHeader(JNIEnv* env,
  ...
  f = nxt_java_findHeader(r->fields, r->fields + r->fields_count, name_str,
                          name_len);
...
void nxt_java_Request_websocket(JNIEnv* env,
                                jobject jreq,
                                jobject jbuf,
                                uint8_t opcode,
                                uint8_t fin) {
  (*env)->CallVoidMethod(env, jreq, nxt_java_Request_processWsFrame, jbuf,
                         opcode, fin);
}
