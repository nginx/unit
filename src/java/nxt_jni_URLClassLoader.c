...
int nxt_java_initURLClassLoader(JNIEnv *env)
{
    ...
    nxt_java_URLClassLoader_ctor = (*env)->GetMethodID(env, cls, "<init>", "([Ljava/net/URL;)V");
    ...
    nxt_java_URLClassLoader_parent_ctor =
        (*env)->GetMethodID(env, cls, "<init>", "([Ljava/net/URL;Ljava/lang/ClassLoader;)V");
    if (nxt_java_URLClassLoader_ctor == NULL)
    {
        nxt_unit_warn(NULL, "java.net.URLClassLoader constructor not found");
        goto failed;
    ...
    nxt_java_URLClassLoader_loadClass =
        (*env)->GetMethodID(env, cls, "loadClass", "(Ljava/lang/String;)Ljava/lang/Class;");
    ...
    nxt_java_URLClassLoader_addURL = (*env)->GetMethodID(env, cls, "addURL", "(Ljava/net/URL;)V");
    ...
    nxt_java_URL_ctor = (*env)->GetMethodID(env, cls, "<init>", "(Ljava/lang/String;)V");
...
jobject nxt_java_newURLClassLoader(JNIEnv *env, int url_count, char **urls)
{
    ...
    return (*env)->NewObject(env, nxt_java_URLClassLoader_class, nxt_java_URLClassLoader_ctor, jurls);
}

jobject nxt_java_newURLClassLoader_parent(JNIEnv *env, int url_count, char **urls, jobject parent)
{
    jobjectArray jurls;
    ...
    return (*env)->NewObject(env, nxt_java_URLClassLoader_class, nxt_java_URLClassLoader_parent_ctor, jurls, parent);
}
...
jclass nxt_java_loadClass(JNIEnv *env, jobject cl, const char *name)
{
    ...
    return (*env)->CallObjectMethod(env, cl, nxt_java_URLClassLoader_loadClass, jname);
}
