...
nxt_java_HeaderNamesEnumeration_nextElementPos(JNIEnv* env,
                                               jclass cls,
                                               jlong headers_ptr,
                                               jlong size,
                                               jlong pos);
static jstring JNICALL
nxt_java_HeaderNamesEnumeration_nextElement(JNIEnv* env,
                                            jclass cls,
                                            jlong headers_ptr,
                                            jlong size,
                                            jlong pos);
...
jobject nxt_java_newHeaderNamesEnumeration(JNIEnv* env,
                                           nxt_unit_field_t* f,
