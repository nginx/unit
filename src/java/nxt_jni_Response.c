...
static jobject JNICALL nxt_java_Response_getHeaderNames(JNIEnv *env, jclass cls,
                                                        jlong req_info_ptr);
...
static int nxt_java_response_set_header(jlong req_info_ptr, const char *name,
                                        jint name_len, const char *value,
                                        jint value_len);
...
static int nxt_java_response_remove_header(jlong req_info_ptr, const char *name,
                                           jint name_len);
...
static jstring JNICALL nxt_java_Response_getContentType(JNIEnv *env, jclass cls,
                                                        jlong req_info_ptr);
