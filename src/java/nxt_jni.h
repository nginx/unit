...
nxt_unit_field_t *nxt_java_findHeader(nxt_unit_field_t *f, nxt_unit_field_t *e, const char *name, uint8_t name_len);
...
static inline jlong nxt_ptr2jlong(void *ptr)
{
    return (jlong)(intptr_t)ptr;
}

static inline void *nxt_jlong2ptr(jlong l)
{
