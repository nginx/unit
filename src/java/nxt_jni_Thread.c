...
int nxt_java_initThread(JNIEnv *env)
{
    ...
    nxt_java_Thread_currentThread = (*env)->GetStaticMethodID(env, cls, "currentThread", "()Ljava/lang/Thread;");
    ...
    nxt_java_Thread_getContextClassLoader =
        (*env)->GetMethodID(env, cls, "getContextClassLoader", "()Ljava/lang/ClassLoader;");
    ...
    nxt_java_Thread_setContextClassLoader =
        (*env)->GetMethodID(env, cls, "setContextClassLoader", "(Ljava/lang/ClassLoader;)V");
...
void nxt_java_setContextClassLoader(JNIEnv *env, jobject cl)
{
    ...
    thread = (*env)->CallStaticObjectMethod(env, nxt_java_Thread_class, nxt_java_Thread_currentThread);
    ...
    (*env)->CallVoidMethod(env, thread, nxt_java_Thread_setContextClassLoader, cl);
}
