...
static void JNICALL nxt_java_Context_log(JNIEnv* env,
                                         jclass cls,
                                         jlong ctx_ptr,
                                         jstring msg,
                                         jint msg_len);
static void JNICALL nxt_java_Context_trace(JNIEnv* env,
                                           jclass cls,
                                           jlong ctx_ptr,
                                           jstring msg,
                                           jint msg_len);
...
int nxt_java_initContext(JNIEnv* env, jobject cl) {
  ...
  res = (*env)->RegisterNatives(
      env, nxt_java_Context_class, context_methods,
...
jobject nxt_java_startContext(JNIEnv* env,
                              const char* webapp,
                              jobject classpaths) {
  jstring webapp_str;
