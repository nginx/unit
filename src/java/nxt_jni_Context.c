...
static void JNICALL nxt_java_Context_log(JNIEnv *env, jclass cls, jlong ctx_ptr, jstring msg, jint msg_len);
static void JNICALL nxt_java_Context_trace(JNIEnv *env, jclass cls, jlong ctx_ptr, jstring msg, jint msg_len);
...
int nxt_java_initContext(JNIEnv *env, jobject cl)
{
    ...
    nxt_java_Context_start =
        (*env)->GetStaticMethodID(env, cls, "start", "(Ljava/lang/String;[Ljava/net/URL;)Lnginx/unit/Context;");
    ...
    nxt_java_Context_service = (*env)->GetMethodID(env, cls, "service", "(Lnginx/unit/Request;Lnginx/unit/Response;)V");
    ...
    JNINativeMethod context_methods[] = {
        ...
        {(char *)"trace", (char *)"(JLjava/lang/String;I)V", nxt_java_Context_trace},
...
jobject nxt_java_startContext(JNIEnv *env, const char *webapp, jobject classpaths)
{
    jstring webapp_str;
    ...
    return (*env)->CallStaticObjectMethod(env, nxt_java_Context_class, nxt_java_Context_start, webapp_str, classpaths);
}
