...
nxt_java_HeadersEnumeration_nextElementPos(JNIEnv* env,
                                           jclass cls,
                                           jlong headers_ptr,
                                           jlong size,
                                           jlong ipos,
...
nxt_java_HeadersEnumeration_nextElement(JNIEnv* env,
                                        jclass cls,
                                        jlong headers_ptr,
                                        jlong size,
                                        jlong ipos,
...
jobject nxt_java_newHeadersEnumeration(JNIEnv* env,
                                       nxt_unit_field_t* f,
