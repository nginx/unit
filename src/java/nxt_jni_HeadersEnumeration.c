...
static jlong JNICALL nxt_java_HeadersEnumeration_nextElementPos (
    JNIEnv *env, jclass cls, jlong headers_ptr, jlong size, jlong ipos,
    jlong pos);

static jstring JNICALL nxt_java_HeadersEnumeration_nextElement (
    JNIEnv *env, jclass cls, jlong headers_ptr, jlong size, jlong ipos,
    jlong pos);
...
nxt_java_initHeadersEnumeration (JNIEnv *env, jobject cl)
{
  ...
  nxt_java_HeadersEnumeration_ctor
      = (*env)->GetMethodID (env, cls, "<init>", "(JJJ)V");
  ...
  JNINativeMethod methods[] = {
    { (char *)"nextElementPos", (char *)"(JJJJ)J",
      nxt_java_HeadersEnumeration_nextElementPos },

    { (char *)"nextElement", (char *)"(JJJJ)Ljava/lang/String;",
                                ...
                                uint32_t fields_count, uint32_t pos)
{
  return (*env)->NewObject (
      env, nxt_java_HeadersEnumeration_class, nxt_java_HeadersEnumeration_ctor,
      nxt_ptr2jlong (f), (jlong)fields_count, (jlong)pos);
}

static jlong JNICALL
nxt_java_HeadersEnumeration_nextElementPos (JNIEnv *env, jclass cls,
                                            jlong headers_ptr, jlong size,
