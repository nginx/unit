...
nxt_inline void nxt_rbtree1_left_rotate(nxt_rbtree1_node_t **root, nxt_rbtree1_node_t *sentinel,
                                        nxt_rbtree1_node_t *node);
nxt_inline void nxt_rbtree1_right_rotate(nxt_rbtree1_node_t **root, nxt_rbtree1_node_t *sentinel,
                                         nxt_rbtree1_node_t *node);

void nxt_rbtree1_insert(nxt_rbtree1_t *tree, nxt_rbtree1_node_t *node)
{
...
void nxt_rbtree1_insert_value(nxt_rbtree1_node_t *temp, nxt_rbtree1_node_t *node, nxt_rbtree1_node_t *sentinel)
{
...
void nxt_rbtree1_insert_timer_value(nxt_rbtree1_node_t *temp, nxt_rbtree1_node_t *node, nxt_rbtree1_node_t *sentinel)
{
    nxt_rbtree1_node_t **p;
    ...
    for (;;)
    {
        ...
        p = ((nxt_rbtree1_key_int_t)(node->key - temp->key) < 0) ? &temp->left : &temp->right;
...
void nxt_rbtree1_delete(nxt_rbtree1_t *tree, nxt_rbtree1_node_t *node)
{
    nxt_uint_t red;
