...
void nxt_rbtree1_insert_value(nxt_rbtree1_node_t *temp,
                              nxt_rbtree1_node_t *node,
                              nxt_rbtree1_node_t *sentinel) {
...
void nxt_rbtree1_insert_timer_value(nxt_rbtree1_node_t *temp,
                                    nxt_rbtree1_node_t *node,
                                    nxt_rbtree1_node_t *sentinel) {
  nxt_rbtree1_node_t **p;
  ...
  for (;;) {
    ...
    p = ((nxt_rbtree1_key_int_t)(node->key - temp->key) < 0) ? &temp->left
                                                             : &temp->right;
