...
nxt_inline nxt_rbtree1_node_t* nxt_rbtree1_node_successor(
    nxt_rbtree1_t* tree,
...
nxt_inline nxt_int_t nxt_rbtree1_test_compare(nxt_rbtree1_node_t* node1,
                                              nxt_rbtree1_node_t* node2) {
...
nxt_int_t nxt_rbtree1_mb_start(nxt_thread_t* thr) {
  ...
  nxt_log_error(NXT_LOG_NOTICE, thr->log, "rbtree1 mb cached insert: %L cycles",
                end - start);
