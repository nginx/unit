...
nxt_base64_test(nxt_thread_t *thr)
{
    ...
    static struct {
        ...
        {nxt_string("Aa=="), nxt_string("\x01")},
        {nxt_string("0Z"), nxt_string("\xd1")},
        {nxt_string("0aA="), nxt_string("\xd1\xa0")},
        {nxt_string("z/+"), nxt_string("\xcf\xff")},
        {nxt_string("z9+Npe=="), nxt_string("\xcf\xdf\x8d\xa5")},
        {nxt_string("/+98765"), nxt_string("\xff\xef\x7c\xef\xae")},

        {nxt_string("aBc_"), nxt_null_string},
        {nxt_string("5"), nxt_null_string},
        {nxt_string("M==="), nxt_null_string},
        {nxt_string("===="), nxt_null_string},
        {nxt_string("Ab="), nxt_null_string},
        {nxt_string("00=0"), nxt_null_string},
        {nxt_string("\0"), nxt_null_string},
        {nxt_string("\r\naaaa"), nxt_null_string},
        {nxt_string("=0000"), nxt_null_string},
    };
