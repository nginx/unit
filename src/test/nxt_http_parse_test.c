...
typedef struct
{
  ...
  nxt_int_t (*handler) (nxt_http_request_parse_t *rp,
                        nxt_http_parse_test_data_t *data, nxt_str_t *request,
                        nxt_log_t *log);
...
static nxt_int_t nxt_http_test_header_return (void *ctx,
...
static nxt_http_parse_test_case_t nxt_http_test_cases[] = {
  { nxt_string ("GET / HTTP/1.0\r\n\r\n"),
    ...
    { .request_line = { nxt_string ("GET"), nxt_string ("/"), nxt_null_string,
                        "HTTP/1.0", 0, 0, 0 } } },
  { nxt_string ("XXX-METHOD    /d.ir/fi+le.ext?key=val    HTTP/1.2\n\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line
      = { nxt_string ("XXX-METHOD"), nxt_string ("/d.ir/fi+le.ext?key=val"),
          nxt_string ("key=val"), "HTTP/1.2", 0, 0, 0 } } },
  { nxt_string ("GET /di.r/? HTTP/1.0\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("/di.r/?"),
                        nxt_string (""), "HTTP/1.0", 0, 0, 0 } } },
  { nxt_string ("GEt / HTTP/1.0\r\n\r\n"),
  ...
  { nxt_string ("GET /?# HTTP/1.0\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("/?#"),
                        nxt_string (""), "HTTP/1.0", 1, 0, 0 } } },
  { nxt_string ("GET // HTTP/1.0\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("//"), nxt_null_string,
  ...
  { nxt_string ("GET /%20 HTTP/1.0\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("/%20"),
                        nxt_null_string, "HTTP/1.0", 0, 1, 0 } } },
  { nxt_string ("GET / a HTTP/1.0\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("/ a"),
                        nxt_null_string, "HTTP/1.0", 0, 0, 1 } } },
  { nxt_string ("GET /na %20me.ext?args HTTP/1.0\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("/na %20me.ext?args"),
                        nxt_string ("args"), "HTTP/1.0", 0, 1, 1 } } },
  { nxt_string ("GET / HTTP/1.0 HTTP/1.1\r\n\r\n"),
    NXT_DONE,
    &nxt_http_parse_test_request_line,
    { .request_line = { nxt_string ("GET"), nxt_string ("/ HTTP/1.0"),
                        nxt_null_string, "HTTP/1.1", 0, 0, 1 } } },
...
static nxt_http_field_proc_t nxt_http_test_bench_fields[] = {
  ...
  { nxt_string ("X-Http-Method-Override"), &nxt_http_test_header_return,
    NXT_OK },
  ...
  { nxt_string ("Upgrade-Insecure-Requests"), &nxt_http_test_header_return,
    NXT_OK },
};

static nxt_str_t nxt_http_test_simple_request
...
nxt_http_parse_test (nxt_thread_t *thr)
{
  ...
  rc = nxt_http_fields_hash (&nxt_http_test_fields_hash, nxt_http_test_fields,
  ...
  colls = nxt_http_fields_hash_collisions (
      &hash, nxt_http_test_bench_fields,
      nxt_nitems (nxt_http_test_bench_fields), 0);

  nxt_memzero (&hash, sizeof (nxt_lvlhsh_t));

  lvl_colls = nxt_http_fields_hash_collisions (
      &hash, nxt_http_test_bench_fields,
      nxt_nitems (nxt_http_test_bench_fields), 1);
  ...
  if (nxt_http_parse_test_bench (thr, &nxt_http_test_simple_request, &hash,
                                 "simple", 1000000)
      != NXT_OK)
    {
      return NXT_ERROR;
  ...
  if (nxt_http_parse_test_bench (thr, &nxt_http_test_big_request, &hash, "big",
                                 100000)
      != NXT_OK)
    {
      return NXT_ERROR;
                           ...
                           nxt_lvlhsh_t *hash, const char *name, nxt_uint_t n)
{
  ...
  nxt_log_error (NXT_LOG_NOTICE, thr->log,
                 "http parse %s request bench: %0.3fs", name,
  ...
  if (memcmp (rp->version.str, test->version, 8) != 0)
    {
      nxt_log_alert (log,
                     ...
                     request, (size_t)8, rp->version.str, (size_t)8,
                     test->version);
      return NXT_ERROR;
    }
...
static nxt_int_t
nxt_http_test_header_return (void *ctx, nxt_http_field_t *field,
                             uintptr_t data)
{
  return data;
}
