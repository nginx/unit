...
typedef struct
{
    nxt_str_t request;
    nxt_int_t result;
    nxt_int_t (*handler)(nxt_http_request_parse_t *rp, nxt_http_parse_test_data_t *data, nxt_str_t *request,
                         nxt_log_t *log);

    nxt_http_parse_test_data_t data;
} nxt_http_parse_test_case_t;

static nxt_int_t nxt_http_parse_test_run(nxt_http_request_parse_t *rp, nxt_str_t *request);
static nxt_int_t nxt_http_parse_test_bench(nxt_thread_t *thr, nxt_str_t *request, nxt_lvlhsh_t *hash, const char *name,
                                           nxt_uint_t n);
static nxt_int_t nxt_http_parse_test_request_line(nxt_http_request_parse_t *rp, nxt_http_parse_test_data_t *data,
                                                  nxt_str_t *request, nxt_log_t *log);
static nxt_int_t nxt_http_parse_test_fields(nxt_http_request_parse_t *rp, nxt_http_parse_test_data_t *data,
                                            nxt_str_t *request, nxt_log_t *log);

static nxt_int_t nxt_http_test_header_return(void *ctx, nxt_http_field_t *field, uintptr_t data);

static nxt_http_parse_test_case_t nxt_http_test_cases[] = {
    {nxt_string("GET / HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/"), nxt_null_string, "HTTP/1.0", 0, 0, 0}}},
    {nxt_string("XXX-METHOD    /d.ir/fi+le.ext?key=val    HTTP/1.2\n\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("XXX-METHOD"), nxt_string("/d.ir/fi+le.ext?key=val"), nxt_string("key=val"),
                       "HTTP/1.2", 0, 0, 0}}},
    {nxt_string("GET /di.r/? HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/di.r/?"), nxt_string(""), "HTTP/1.0", 0, 0, 0}}},
    {nxt_string("GEt / HTTP/1.0\r\n\r\n"), NXT_HTTP_PARSE_INVALID, NULL, {NULL}},
    {nxt_string("GET /\0 HTTP/1.0\r\n\r\n"), NXT_HTTP_PARSE_INVALID, NULL, {NULL}},
    {nxt_string("GET /\r HTTP/1.0\r\n\r\n"), NXT_HTTP_PARSE_INVALID, NULL, {NULL}},
    {nxt_string("GET /\n HTTP/1.0\r\n\r\n"), NXT_HTTP_PARSE_INVALID, NULL, {NULL}},
    {nxt_string("GET / HTTP/1.0\r\r\n"), NXT_HTTP_PARSE_INVALID, NULL, {NULL}},
    {nxt_string("GET / HTTP/2.0\r\n"), NXT_HTTP_PARSE_UNSUPPORTED_VERSION, NULL, {NULL}},
    {nxt_string("GET /. HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/."), nxt_null_string, "HTTP/1.0", 1, 0, 0}}},
    {nxt_string("GET /# HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/#"), nxt_null_string, "HTTP/1.0", 1, 0, 0}}},
    {nxt_string("GET /?# HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/?#"), nxt_string(""), "HTTP/1.0", 1, 0, 0}}},
    {nxt_string("GET // HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("//"), nxt_null_string, "HTTP/1.0", 1, 0, 0}}},
    {nxt_string("GET /%20 HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/%20"), nxt_null_string, "HTTP/1.0", 0, 1, 0}}},
    {nxt_string("GET / a HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/ a"), nxt_null_string, "HTTP/1.0", 0, 0, 1}}},
    {nxt_string("GET /na %20me.ext?args HTTP/1.0\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/na %20me.ext?args"), nxt_string("args"), "HTTP/1.0", 0, 1, 1}}},
    {nxt_string("GET / HTTP/1.0 HTTP/1.1\r\n\r\n"),
     NXT_DONE,
     &nxt_http_parse_test_request_line,
     {.request_line = {nxt_string("GET"), nxt_string("/ HTTP/1.0"), nxt_null_string, "HTTP/1.1", 0, 0, 1}}},
...
static nxt_http_field_proc_t nxt_http_test_fields[] = {
    {nxt_string("X-Bad-Header"), &nxt_http_test_header_return, NXT_ERROR},

    {nxt_string("X-Good-Header"), &nxt_http_test_header_return, NXT_OK},

    {nxt_string("!#$%&'*+.^_`|~"), &nxt_http_test_header_return, NXT_ERROR},
};

static nxt_lvlhsh_t nxt_http_test_fields_hash;

static nxt_http_field_proc_t nxt_http_test_bench_fields[] = {
    {nxt_string("Host"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("User-Agent"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Accept"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Accept-Encoding"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Accept-Language"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Connection"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Content-Length"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Content-Range"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Content-Type"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Cookie"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Range"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("If-Range"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Transfer-Encoding"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Expect"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Via"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("If-Modified-Since"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("If-Unmodified-Since"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("If-Match"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("If-None-Match"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Referer"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Date"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Upgrade"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Authorization"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Keep-Alive"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("X-Forwarded-For"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("X-Forwarded-Host"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("X-Forwarded-Proto"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("X-Http-Method-Override"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("X-Real-IP"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("X-Request-ID"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("TE"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Pragma"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Cache-Control"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Origin"), &nxt_http_test_header_return, NXT_OK},
    {nxt_string("Upgrade-Insecure-Requests"), &nxt_http_test_header_return, NXT_OK},
};

static nxt_str_t nxt_http_test_simple_request = nxt_string("GET /page HTTP/1.1\r\n"
                                                           "Host: example.com\r\n\r\n");

static nxt_str_t nxt_http_test_big_request =
    nxt_string("POST /path/to/very/interesting/article/on.this.site?arg1=value&arg2=value"
...
nxt_int_t nxt_http_parse_test(nxt_thread_t *thr)
{
    ...
    rc = nxt_http_fields_hash(&nxt_http_test_fields_hash, nxt_http_test_fields, nxt_nitems(nxt_http_test_fields));
    if (rc != NXT_OK)
    {
        return NXT_ERROR;
    }
    ...
    for (i = 0; i < nxt_nitems(nxt_http_test_cases); i++)
    {
        ...
        if (test->handler != NULL && test->handler(&rp, &test->data, &test->request, thr->log) != NXT_OK)
        {
            return NXT_ERROR;
        }
    ...
    colls =
        nxt_http_fields_hash_collisions(&hash, nxt_http_test_bench_fields, nxt_nitems(nxt_http_test_bench_fields), 0);

    nxt_memzero(&hash, sizeof(nxt_lvlhsh_t));

    lvl_colls =
        nxt_http_fields_hash_collisions(&hash, nxt_http_test_bench_fields, nxt_nitems(nxt_http_test_bench_fields), 1);

    nxt_log_error(NXT_LOG_NOTICE, thr->log, "http parse test hash collisions %ui out of %uz, level: %ui", colls,
                  nxt_nitems(nxt_http_test_bench_fields), lvl_colls);

    nxt_memzero(&hash, sizeof(nxt_lvlhsh_t));

    rc = nxt_http_fields_hash(&hash, nxt_http_test_bench_fields, nxt_nitems(nxt_http_test_bench_fields));
    if (rc != NXT_OK)
    {
        return NXT_ERROR;
    }

    if (nxt_http_parse_test_bench(thr, &nxt_http_test_simple_request, &hash, "simple", 1000000) != NXT_OK)
    {
        return NXT_ERROR;
    }

    if (nxt_http_parse_test_bench(thr, &nxt_http_test_big_request, &hash, "big", 100000) != NXT_OK)
    {
        return NXT_ERROR;
    }
                                           ...
                                           nxt_uint_t n)
{
    ...
    nxt_log_error(NXT_LOG_NOTICE, thr->log, "http parse %s request bench started: %uz bytes, %ui runs", name,
                  request->length, n);
    ...
    for (i = 0; nxt_fast_path(i < n); i++)
    {
        ...
        {
            nxt_log_alert(thr->log,
                          "http parse %s request bench failed "
                          "while parsing",
                          name);
            return NXT_ERROR;
        }

        if (nxt_slow_path(nxt_http_fields_process(rp.fields, hash, NULL) != NXT_OK))
        {
            nxt_log_alert(thr->log,
                          "http parse %s request bench failed "
                          "while fields processing",
                          name);
            return NXT_ERROR;
        }
    ...
    nxt_log_error(NXT_LOG_NOTICE, thr->log, "http parse %s request bench: %0.3fs", name, (end - start) / 1000000000.0);
                                                  ...
                                                  nxt_str_t *request, nxt_log_t *log)
{
    ...
    if (rp->method.start != test->method.start && !nxt_strstr_eq(&rp->method, &test->method))
    {
        nxt_log_alert(log,
                      "http parse test case failed:\n"
                      " - request:\n\"%V\"\n"
    ...
    if (str.start != test->target.start && !nxt_strstr_eq(&str, &test->target))
    {
        nxt_log_alert(log,
                      "http parse test case failed:\n"
                      " - request:\n\"%V\"\n"
    ...
    if (rp->args.start != test->args.start && !nxt_strstr_eq(&rp->args, &test->args))
    {
        nxt_log_alert(log,
                      "http parse test case failed:\n"
                      " - request:\n\"%V\"\n"
    ...
    if (memcmp(rp->version.str, test->version, 8) != 0)
    {
        nxt_log_alert(log,
                      ...
                      request, (size_t)8, rp->version.str, (size_t)8, test->version);
        return NXT_ERROR;
    }
