...
NXT_EXPORT nxt_int_t nxt_file_open(nxt_task_t* task,
                                   nxt_file_t* file,
                                   nxt_uint_t mode,
                                   nxt_uint_t create,
...
#if (NXT_HAVE_OPENAT2)
NXT_EXPORT nxt_int_t nxt_file_openat2(nxt_task_t* task,
                                      nxt_file_t* file,
                                      nxt_uint_t mode,
                                      nxt_uint_t create,
                                      nxt_file_access_t access,
...
NXT_EXPORT ssize_t nxt_file_write(nxt_file_t* file,
                                  const u_char* buf,
                                  size_t size,
                                  nxt_off_t offset);
NXT_EXPORT ssize_t nxt_file_read(nxt_file_t* file,
                                 u_char* buf,
                                 size_t size,
                                 nxt_off_t offset);
NXT_EXPORT void nxt_file_read_ahead(nxt_file_t* file,
                                    nxt_off_t offset,
                                    size_t size);
...
NXT_EXPORT nxt_int_t nxt_file_set_access(nxt_file_name_t* name,
                                         nxt_file_access_t access);
NXT_EXPORT nxt_int_t nxt_file_chown(nxt_file_name_t* name,
                                    const char* owner,
                                    const char* group);
...
NXT_EXPORT FILE* nxt_file_fopen(nxt_task_t* task,
                                const char* pathname,
                                const char* mode);
...
NXT_EXPORT nxt_int_t nxt_pipe_create(nxt_task_t* task,
                                     nxt_fd_t* pp,
                                     nxt_bool_t nbread,
                                     nxt_bool_t nbwrite);
