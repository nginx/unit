...
ssize_t nxt_linux_event_conn_io_sendfile(nxt_conn_t* c,
                                         nxt_buf_t* b,
                                         size_t limit);
#endif
...
#define NXT_HAVE_SENDFILE 1
ssize_t nxt_freebsd_event_conn_io_sendfile(nxt_conn_t* c,
                                           nxt_buf_t* b,
                                           size_t limit);
#endif
...
#define NXT_HAVE_SENDFILE 1
ssize_t nxt_solaris_event_conn_io_sendfilev(nxt_conn_t* c,
                                            nxt_buf_t* b,
                                            size_t limit);
#endif
...
#define NXT_HAVE_SENDFILE 1
ssize_t nxt_macosx_event_conn_io_sendfile(nxt_conn_t* c,
                                          nxt_buf_t* b,
                                          size_t limit);
#endif
...
#define NXT_HAVE_SENDFILE 1
ssize_t nxt_aix_event_conn_io_send_file(nxt_conn_t* c,
                                        nxt_buf_t* b,
                                        size_t limit);
#endif
...
#define NXT_HAVE_SENDFILE 1
ssize_t nxt_hpux_event_conn_io_sendfile(nxt_conn_t* c,
                                        nxt_buf_t* b,
                                        size_t limit);
#endif
...
nxt_uint_t nxt_sendbuf_mem_coalesce0(nxt_task_t* task,
                                     nxt_sendbuf_t* sb,
                                     struct iovec* iov,
                                     nxt_uint_t niov_max);
 ...
 */
ssize_t nxt_sendbuf_copy_coalesce(nxt_conn_t* c,
                                  nxt_buf_mem_t* bm,
                                  nxt_buf_t* b,
                                  size_t limit);

nxt_buf_t* nxt_sendbuf_update(nxt_buf_t* b, size_t sent);
nxt_buf_t* nxt_sendbuf_completion(nxt_task_t* task,
                                  nxt_work_queue_t* wq,
                                  nxt_buf_t* b);
