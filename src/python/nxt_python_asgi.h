...
PyObject *
nxt_py_asgi_calc_size(void *data, int i, PyObject *n, PyObject *v);
PyObject *
nxt_py_asgi_add_field(void *data, int i, PyObject *n, PyObject *v);
...
void
nxt_py_asgi_websocket_handler(nxt_unit_websocket_frame_t *ws);
void
