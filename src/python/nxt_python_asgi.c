...
PyObject *nxt_py_asgi_calc_size(void *data, int i, PyObject *name,
                                PyObject *val) {
...
PyObject *nxt_py_asgi_add_field(void *data, int i, PyObject *name,
                                PyObject *val) {
  int rc;
...
void nxt_py_asgi_dealloc(PyObject *self) { PyObject_Del(self); }
...
PyObject *nxt_py_asgi_next(PyObject *self) { return NULL; }
