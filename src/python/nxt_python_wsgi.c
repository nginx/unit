...
static int nxt_python_add_py_string(nxt_python_ctx_t *pctx, PyObject *name,
                                    PyObject *value);
static int nxt_python_add_field(nxt_python_ctx_t *pctx, nxt_unit_field_t *field,
                                int n, uint32_t vl);
...
static int nxt_python_response_add_field(nxt_python_ctx_t *pctx, PyObject *name,
...
static int nxt_python_wsgi_ctx_data_alloc(void **pdata, int main) {
  ...
  pctx->start_resp =
      PyCFunction_New(nxt_py_start_resp_method, (PyObject *)pctx);
...
static void nxt_py_input_dealloc(nxt_python_ctx_t *self) { PyObject_Del(self); }
