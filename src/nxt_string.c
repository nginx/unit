...
u_char *nxt_memstrn(const u_char *s, const u_char *end, const char *ss,
                    size_t length) {
  u_char c1, c2, *s2;
...
u_char *nxt_memcasestrn(const u_char *s, const u_char *end, const char *ss,
                        size_t length) {
  u_char c1, c2, *s2;
...
u_char *nxt_rmemstrn(const u_char *s, const u_char *end, const char *ss,
                     size_t length) {
  u_char c1, c2;
  const u_char *s1, *s2;
