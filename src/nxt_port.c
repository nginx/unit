...
void nxt_port_reset_next_id(void) { nxt_port_last_id = 1; }
...
nxt_inline void nxt_port_send_new_port(nxt_task_t *task, nxt_runtime_t *rt,
...
static void nxt_port_release_handler(nxt_task_t *task, nxt_port_t *port,
                                     void *data) {
  /* no op */
}
