...
nxt_sockaddr_alloc(nxt_mp_t *mp, socklen_t socklen,
                   size_t address_length) NXT_MALLOC_LIKE;
NXT_EXPORT nxt_sockaddr_t *
nxt_sockaddr_create(nxt_mp_t *mp, struct sockaddr *sockaddr, socklen_t socklen,
                    size_t address_length) NXT_MALLOC_LIKE;
NXT_EXPORT nxt_sockaddr_t *
nxt_sockaddr_copy(nxt_mp_t *mp, nxt_sockaddr_t *src) NXT_MALLOC_LIKE;
NXT_EXPORT nxt_sockaddr_t *
nxt_getsockname(nxt_task_t *task, nxt_mp_t *mp, nxt_socket_t s) NXT_MALLOC_LIKE;
NXT_EXPORT void
...
#endif
NXT_EXPORT nxt_bool_t
nxt_inet6_probe(nxt_str_t *addr);
