...
#define nxt_lvlhsh_store_bucket(slot, bkt) slot = (void **)((uintptr_t)bkt | 2 | 1)

#define nxt_lvlhsh_bucket_size(proto) proto->bucket_size

#define nxt_lvlhsh_bucket(proto, bkt) (uint32_t *)((uintptr_t)bkt & ~(uintptr_t)proto->bucket_mask)

#define nxt_lvlhsh_bucket_entries(proto, bkt) (((uintptr_t)bkt & (uintptr_t)proto->bucket_mask) >> 1)
...
static nxt_int_t nxt_lvlhsh_level_find(nxt_lvlhsh_query_t *lhq, void **lvl, uint32_t key, nxt_uint_t nlvl);
...
static nxt_int_t nxt_lvlhsh_level_insert(nxt_lvlhsh_query_t *lhq, void **slot, uint32_t key, nxt_uint_t nlvl);
static nxt_int_t nxt_lvlhsh_bucket_insert(nxt_lvlhsh_query_t *lhq, void **slot, uint32_t key, nxt_int_t nlvl);
static nxt_int_t nxt_lvlhsh_convert_bucket_to_level(nxt_lvlhsh_query_t *lhq, void **slot, nxt_uint_t nlvl,
                                                    uint32_t *bucket);
static nxt_int_t nxt_lvlhsh_level_convertion_insert(nxt_lvlhsh_query_t *lhq, void **parent, uint32_t key,
                                                    nxt_uint_t nlvl);
static nxt_int_t nxt_lvlhsh_bucket_convertion_insert(nxt_lvlhsh_query_t *lhq, void **slot, uint32_t key,
                                                     nxt_int_t nlvl);
static nxt_int_t nxt_lvlhsh_free_level(nxt_lvlhsh_query_t *lhq, void **level, nxt_uint_t size);
static nxt_int_t nxt_lvlhsh_level_delete(nxt_lvlhsh_query_t *lhq, void **slot, uint32_t key, nxt_uint_t nlvl);
static nxt_int_t nxt_lvlhsh_bucket_delete(nxt_lvlhsh_query_t *lhq, void **bkt);
static void *nxt_lvlhsh_level_each(nxt_lvlhsh_each_t *lhe, void **level, nxt_uint_t nlvl, nxt_uint_t shift);
static void *nxt_lvlhsh_bucket_each(nxt_lvlhsh_each_t *lhe);
static void *nxt_lvlhsh_level_peek(nxt_lvlhsh_peek_t *peek, void **level, nxt_uint_t nlvl);
static void *nxt_lvlhsh_bucket_peek(nxt_lvlhsh_peek_t *peek, void **bkt);

nxt_int_t nxt_lvlhsh_find(nxt_lvlhsh_t *lh, nxt_lvlhsh_query_t *lhq)
{
    void *slot;
...
nxt_int_t nxt_lvlhsh_insert(nxt_lvlhsh_t *lh, nxt_lvlhsh_query_t *lhq)
{
    uint32_t key;
...
static nxt_int_t nxt_lvlhsh_level_insert(nxt_lvlhsh_query_t *lhq, void **parent, uint32_t key, nxt_uint_t nlvl)
{
    void **slot, **lvl;
    nxt_int_t ret;
    uintptr_t mask;
...
static nxt_int_t nxt_lvlhsh_bucket_convertion_insert(nxt_lvlhsh_query_t *lhq, void **slot, uint32_t key, nxt_int_t nlvl)
{
    void **bkt;
    uint32_t *bucket, *e;
    nxt_int_t ret;
...
nxt_int_t nxt_lvlhsh_delete(nxt_lvlhsh_t *lh, nxt_lvlhsh_query_t *lhq)
{
    if (nxt_fast_path(lh->slot != NULL))
    {
...
static nxt_int_t nxt_lvlhsh_level_delete(nxt_lvlhsh_query_t *lhq, void **parent, uint32_t key, nxt_uint_t nlvl)
{
    void **slot, **lvl;
    uintptr_t mask;
    nxt_int_t ret;
...
void *nxt_lvlhsh_each(nxt_lvlhsh_t *lh, nxt_lvlhsh_each_t *lhe)
{
    void **slot;
...
static void *nxt_lvlhsh_level_each(nxt_lvlhsh_each_t *lhe, void **level, nxt_uint_t nlvl, nxt_uint_t shift)
{
    ...
    do
    {
        ...
        if (slot != NULL)
        {
            ...
            {
                value = nxt_lvlhsh_level_each(lhe, slot, nlvl + 1, shift + level_shift);
                if (value != NULL)
                {
                    return value;
                }
...
static nxt_noinline void *nxt_lvlhsh_bucket_each(nxt_lvlhsh_each_t *lhe)
{
    void *value, **next;
    uint32_t *bucket;
    ...
    if (lhe->entries == 0)
    {
        ...
        lhe->bucket = (next == NULL) ? NXT_LVLHSH_BUCKET_DONE : nxt_lvlhsh_bucket(lhe->proto, next);
...
void *nxt_lvlhsh_peek(nxt_lvlhsh_t *lh, const nxt_lvlhsh_proto_t *proto)
{
    void **slot;
...
static void *nxt_lvlhsh_level_peek(nxt_lvlhsh_peek_t *peek, void **parent, nxt_uint_t nlvl)
{
...
static nxt_noinline void *nxt_lvlhsh_bucket_peek(nxt_lvlhsh_peek_t *peek, void **bkt)
{
    void *value;
...
void *nxt_lvlhsh_retrieve(nxt_lvlhsh_t *lh, const nxt_lvlhsh_proto_t *proto, void *pool)
{
    void **slot;
    nxt_lvlhsh_peek_t peek;
