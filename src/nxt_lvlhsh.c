...
static nxt_int_t nxt_lvlhsh_level_insert(nxt_lvlhsh_query_t *lhq, void **slot,
                                         uint32_t key, nxt_uint_t nlvl);
static nxt_int_t nxt_lvlhsh_bucket_insert(nxt_lvlhsh_query_t *lhq, void **slot,
...
static nxt_int_t nxt_lvlhsh_level_insert(nxt_lvlhsh_query_t *lhq, void **parent,
                                         uint32_t key, nxt_uint_t nlvl) {
  void **slot, **lvl;
  nxt_int_t ret;
  uintptr_t mask;
...
static nxt_int_t nxt_lvlhsh_level_delete(nxt_lvlhsh_query_t *lhq, void **parent,
                                         uint32_t key, nxt_uint_t nlvl) {
  void **slot, **lvl;
  uintptr_t mask;
  nxt_int_t ret;
...
static void *nxt_lvlhsh_level_peek(nxt_lvlhsh_peek_t *peek, void **parent,
                                   nxt_uint_t nlvl) {
...
static nxt_noinline void *nxt_lvlhsh_bucket_peek(nxt_lvlhsh_peek_t *peek,
                                                 void **bkt) {
  void *value;
...
void *nxt_lvlhsh_retrieve(nxt_lvlhsh_t *lh, const nxt_lvlhsh_proto_t *proto,
                          void *pool) {
  void **slot;
  nxt_lvlhsh_peek_t peek;
