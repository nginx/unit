...
struct nxt_napi
{
    ...
    inline napi_value coerce_to_string(napi_value val)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value create_buffer(size_t size, void **data)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value create_function(const char *name, size_t len, napi_callback cb, void *data)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value create_function(napi_callback cb)
    {
        return create_function(NULL, 0, cb, NULL);
    }

    inline napi_value create_object()
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_ref create_reference(napi_value val, int ref_count = 1)
    {
        napi_ref res;
        napi_status status;
    ...
    inline napi_value create_string_latin1(const char *str, size_t len)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value create_string_latin1(nxt_unit_sptr_t &str, size_t len)
    {
        const char *p;
    ...
    inline napi_value define_class(const char *name, napi_callback ctor, size_t prop_count,
                                   const napi_property_descriptor *props)
    {
        napi_value res;
        napi_status status;

        status = napi_define_class(env_, name, NAPI_AUTO_LENGTH, ctor, nullptr, prop_count, props, &res);
        if (status != napi_ok)
        {
    ...
    inline void delete_reference(napi_ref ref)
    {
        napi_delete_reference(env_, ref);
    }

    inline uint32_t get_array_length(napi_value val)
    {
        uint32_t res;
        napi_status status;
    ...
    inline void *get_buffer_info(napi_value val, size_t &size)
    {
        void *res;
        napi_status status;
    ...
    inline napi_value get_cb_info(napi_callback_info info, size_t &argc, napi_value *argv)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_cb_info(napi_callback_info info)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_cb_info(napi_callback_info info, napi_value &arg)
    {
        size_t argc;
        napi_value res;
    ...
    inline napi_value get_element(napi_value obj, uint32_t i)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_named_property(napi_value obj, const char *name)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_new_target(napi_callback_info info)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_property(napi_value val, napi_value key)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_property_names(napi_value val)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value get_reference_value(napi_ref ref)
    {
        napi_value res;
        napi_status status;
    ...
    inline nxt_unit_request_info_t *get_request_info(napi_value obj)
    {
        return (nxt_unit_request_info_t *)unwrap(obj);
    }

    inline uint32_t get_value_bool(napi_value obj)
    {
        bool res;
        napi_status status;
    ...
    inline size_t get_value_string_latin1(napi_value val, char *buf, size_t bufsize)
    {
        size_t res;
        napi_status status;
    ...
    inline uint32_t get_value_uint32(napi_value obj)
    {
        uint32_t res;
        napi_status status;
    ...
    inline size_t get_value_string_utf8(napi_value val, char *buf, size_t bufsize)
    {
        size_t res;
        napi_status status;
    ...
    inline bool is_array(napi_value val)
    {
        bool res;
        napi_status status;
    ...
    inline bool is_buffer(napi_value val)
    {
        bool res;
        napi_status status;
    ...
    inline napi_value make_callback(napi_async_context ctx, napi_value val, napi_value func, int argc,
    ...
    inline napi_value make_callback(napi_async_context ctx, napi_value val, napi_value func)
    {
        return make_callback(ctx, val, func, 0, NULL);
    }

    inline napi_value make_callback(napi_async_context ctx, napi_value val, napi_value func, napi_value arg1)
    {
    ...
    inline napi_value new_instance(napi_value ctor)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value new_instance(napi_value ctor, napi_value param)
    {
        napi_value res;
        napi_status status;
    ...
    inline napi_value new_instance(napi_value ctor, napi_value param1, napi_value param2)
    {
        napi_value res;
        napi_status status;
    ...
    inline void set_element(napi_value obj, uint32_t i, napi_value val)
    {
        napi_status status;
    ...
    inline void set_named_property(napi_value obj, const char *name, napi_value val)
    {
        napi_status status;
    ...
    inline void set_named_property(napi_value obj, const char *name, napi_callback cb)
    {
        set_named_property(obj, name, create_function(cb));
    }

    inline napi_value set_named_property(napi_value obj, const char *name, nxt_unit_sptr_t &val, size_t len)
    {
        napi_value str;
    ...
    template <typename T> inline void set_named_property(napi_value obj, const char *name, T val)
    {
        set_named_property(obj, name, create(val));
    }

    inline napi_value create(int32_t val)
    {
        napi_value ptr;
        napi_status status;
    ...
    inline napi_value create(uint32_t val)
    {
        napi_value ptr;
        napi_status status;
    ...
    inline napi_value create(int64_t val)
    {
        napi_value ptr;
        napi_status status;
    ...
    inline void remove_wrap(napi_ref &ref)
    {
        if (ref != nullptr)
        {
    ...
    inline void *remove_wrap(napi_value val)
    {
        void *res;
        napi_status status;
    ...
    inline void throw_error(const char *str)
    {
        napi_throw_error(env_, NULL, str);
    }

    inline void throw_error(const exception &e)
    {
        napi_throw_error(env_, NULL, e.str);
    }

    inline napi_valuetype type_of(napi_value val)
    {
        napi_status status;
        napi_valuetype res;
    ...
    inline void *unwrap(napi_value val)
    {
        void *res;
        napi_status status;
    ...
    inline napi_ref wrap(napi_value val, void *obj, napi_finalize fin_cb, void *hint = nullptr)
    {
        napi_ref res;
        napi_status status;
...
{
    nxt_async_context(napi_env env, const char *name) : nxt_napi(env)
    {
        napi_value name_val;
        napi_status status;
...
{
    nxt_callback_scope(nxt_async_context &ctx) : nxt_napi(ctx.env())
    {
        napi_value resource;
        napi_status status;
