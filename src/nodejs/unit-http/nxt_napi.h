...
struct nxt_napi {
  ...
  inline napi_value create_function(const char* name,
                                    size_t len,
                                    napi_callback cb,
                                    void* data) {
    napi_value res;
  ...
  inline napi_value define_class(const char* name,
                                 napi_callback ctor,
                                 size_t prop_count,
  ...
  inline size_t get_value_string_latin1(napi_value val,
                                        char* buf,
                                        size_t bufsize) {
    size_t res;
    napi_status status;
  ...
  inline size_t get_value_string_utf8(napi_value val,
                                      char* buf,
                                      size_t bufsize) {
    size_t res;
    napi_status status;
  ...
  inline napi_value make_callback(napi_async_context ctx,
                                  napi_value val,
                                  napi_value func,
                                  int argc,
  ...
  inline void set_named_property(napi_value obj,
                                 const char* name,
                                 napi_value val) {
    napi_status status;
  ...
  inline napi_value set_named_property(napi_value obj,
                                       const char* name,
                                       nxt_unit_sptr_t& val,
                                       size_t len) {
    napi_value str;
  ...
  inline napi_ref wrap(napi_value val,
                       void* obj,
