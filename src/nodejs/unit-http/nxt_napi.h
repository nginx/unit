...
struct nxt_napi {
  ...
  inline napi_value create_function(const char *name, size_t len,
  ...
  inline napi_value define_class(const char *name, napi_callback ctor,
                                 size_t prop_count,
  ...
  inline napi_value get_cb_info(napi_callback_info info, size_t &argc,
                                napi_value *argv) {
    napi_value res;
    napi_status status;
  ...
  inline size_t get_value_string_latin1(napi_value val, char *buf,
                                        size_t bufsize) {
    size_t res;
    napi_status status;
  ...
  inline size_t get_value_string_utf8(napi_value val, char *buf,
                                      size_t bufsize) {
    size_t res;
    napi_status status;
  ...
  inline napi_value make_callback(napi_async_context ctx, napi_value val,
                                  napi_value func, int argc,
  ...
  inline napi_value make_callback(napi_async_context ctx, napi_value val,
                                  napi_value func, napi_value arg1) {
  ...
  inline napi_value new_instance(napi_value ctor, napi_value param1,
                                 napi_value param2) {
    napi_value res;
    napi_status status;
  ...
  inline void set_named_property(napi_value obj, const char *name,
                                 napi_value val) {
    napi_status status;
  ...
  inline napi_value set_named_property(napi_value obj, const char *name,
                                       nxt_unit_sptr_t &val, size_t len) {
    napi_value str;
  ...
  template <typename T>
  inline void set_named_property(napi_value obj, const char *name, T val) {
  ...
  inline napi_ref wrap(napi_value val, void *obj, napi_finalize fin_cb,
                       void *hint = nullptr) {
    napi_ref res;
    napi_status status;
  ...
  inline operator napi_env() { return env_; }
