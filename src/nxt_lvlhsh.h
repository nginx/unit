...
#define NXT_LVLHSH_BUCKET_END(bucket_size)                                                                             \
    (((bucket_size) - sizeof(void *)) / (NXT_LVLHSH_ENTRY_SIZE * sizeof(uint32_t)) * NXT_LVLHSH_ENTRY_SIZE)

#define NXT_LVLHSH_BUCKET_SIZE(bucket_size) NXT_LVLHSH_BUCKET_END(bucket_size), bucket_size, (bucket_size - 1)

#define NXT_LVLHSH_DEFAULT NXT_LVLHSH_BUCKET_SIZE(NXT_LVLHSH_DEFAULT_BUCKET_SIZE), {4, 4, 4, 4, 4, 4, 4, 0}

#define NXT_LVLHSH_LARGE_SLAB NXT_LVLHSH_BUCKET_SIZE(NXT_LVLHSH_DEFAULT_BUCKET_SIZE), {10, 4, 4, 4, 4, 4, 4, 0}

#define NXT_LVLHSH_LARGE_MEMALIGN                                                                                      \
    NXT_LVLHSH_BUCKET_SIZE(NXT_LVLHSH_DEFAULT_BUCKET_SIZE), {NXT_LVLHSH_MAX_MEMALIGN_SHIFT, 4, 4, 4, 4, 0, 0, 0}
...
#define nxt_lvlhsh_is_empty(lh) ((lh)->slot == NULL)

#define nxt_lvlhsh_init(lh) (lh)->slot = NULL
 ...
 */
NXT_EXPORT nxt_int_t nxt_lvlhsh_insert(nxt_lvlhsh_t *lh, nxt_lvlhsh_query_t *lhq);
 ...
 * The optional nxt_lvlhsh_query_t fields: pool.
 */
NXT_EXPORT nxt_int_t nxt_lvlhsh_delete(nxt_lvlhsh_t *lh, nxt_lvlhsh_query_t *lhq);
 ...
 */
NXT_EXPORT void *nxt_lvlhsh_peek(nxt_lvlhsh_t *lh, const nxt_lvlhsh_proto_t *proto);
 ...
 */
NXT_EXPORT void *nxt_lvlhsh_retrieve(nxt_lvlhsh_t *lh, const nxt_lvlhsh_proto_t *proto, void *pool);
