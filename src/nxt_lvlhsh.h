...
#define NXT_LVLHSH_BUCKET_END(bucket_size)                                    \
  (((bucket_size) - sizeof (void *))                                          \
   / (NXT_LVLHSH_ENTRY_SIZE * sizeof (uint32_t)) * NXT_LVLHSH_ENTRY_SIZE)
 ...
 */
NXT_EXPORT nxt_int_t nxt_lvlhsh_find (nxt_lvlhsh_t *lh,
 ...
 *
 * The required nxt_lvlhsh_query_t fields: key_hash, key, proto, replace,
 * value. The optional nxt_lvlhsh_query_t fields: pool.
 */
