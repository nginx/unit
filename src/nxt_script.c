...
static nxt_script_t* nxt_script_get(nxt_task_t* task,
                                    nxt_str_t* name,
                                    nxt_fd_t fd);
...
nxt_script_t* nxt_script_new(nxt_task_t* task,
                             nxt_str_t* name,
                             u_char* data,
                             size_t size,
                             u_char* error) {
...
static nxt_int_t nxt_script_info_hash_test(nxt_lvlhsh_query_t* lhq,
                                           void* data) {
...
static nxt_conf_value_t* nxt_script_details(nxt_mp_t* mp,
                                            nxt_script_t* script) {
  nxt_conf_value_t* value;
...
void nxt_script_store_get(nxt_task_t* task,
                          nxt_str_t* name,
                          nxt_mp_t* mp,
...
void nxt_script_store_delete(nxt_task_t* task, nxt_str_t* name, nxt_mp_t* mp) {
  ...
  if (nxt_fast_path(b != NULL)) {
    ...
    *b->mem.free++ = '\0';
    ...
    (void)nxt_port_socket_write(task, main_port, NXT_PORT_MSG_SCRIPT_DELETE, -1,
                                0, 0, b);
  }
}
