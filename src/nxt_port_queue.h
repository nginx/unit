...
nxt_inline void nxt_port_queue_init(nxt_port_queue_t volatile *q)
{
    nxt_nncq_atomic_t i;
...
nxt_inline nxt_int_t nxt_port_queue_send(nxt_port_queue_t volatile *q, const void *p, uint8_t size, int *notify)
{
    nxt_nncq_atomic_t i;
...
nxt_inline ssize_t nxt_port_queue_recv(nxt_port_queue_t volatile *q, void *p)
{
    ssize_t res;
    nxt_nncq_atomic_t i;
    nxt_port_queue_item_t *qi;
