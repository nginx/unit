...
static void nxt_wasmtime_err_msg(wasmtime_error_t *error, wasm_trap_t *trap,
                                 const char *fmt, ...) {
  va_list args;
...
static wasm_trap_t *nxt_wasm_response_end(void *env, wasmtime_caller_t *caller,
...
static wasm_trap_t *nxt_wasm_send_response(void *env, wasmtime_caller_t *caller,
                                           const wasmtime_val_t *args,
                                           size_t nargs,
...
static wasm_trap_t *nxt_wasm_send_headers(void *env, wasmtime_caller_t *caller,
                                          const wasmtime_val_t *args,
                                          size_t nargs, wasmtime_val_t *results,
                                          size_t nresults) {
