...
#define nxt_list_part(list) (&(list)->part)

#define nxt_list_data(part) ((void *)part->data)

#define nxt_list_first(list) nxt_list_data(nxt_list_part(list))

nxt_inline void *nxt_list_elt(nxt_list_t *list, nxt_uint_t n)
{
    nxt_list_part_t *part;
...
#define nxt_list_next_value(list, next) (nxt_pointer_to(nxt_list_data((next)->part), (next)->elt * (list)->size))

nxt_inline nxt_uint_t nxt_list_nelts(nxt_list_t *list)
{
    nxt_uint_t n;
    nxt_list_part_t *part;
