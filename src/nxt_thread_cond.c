...
nxt_int_t nxt_thread_cond_create(nxt_thread_cond_t *cond)
{
    nxt_err_t err;
...
void nxt_thread_cond_destroy(nxt_thread_cond_t *cond)
{
    nxt_err_t err;
...
nxt_int_t nxt_thread_cond_signal(nxt_thread_cond_t *cond)
{
    nxt_err_t err;
...
nxt_err_t nxt_thread_cond_wait(nxt_thread_cond_t *cond, nxt_thread_mutex_t *mtx, nxt_nsec_t timeout)
{
    nxt_err_t err;
    nxt_nsec_t ns;
    nxt_thread_t *thr;
    ...
    else
    {
        ...
        {
            nxt_log_debug(thr->log, "pthread_cond_timedwait(%p) exit: %d", cond, err);
            return err;
        }
