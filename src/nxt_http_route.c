...
static nxt_http_route_t *nxt_http_route_create(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_conf_value_t *cv);
static nxt_http_route_match_t *nxt_http_route_match_create(nxt_task_t *task, nxt_router_temp_conf_t *tmcf,
                                                           nxt_conf_value_t *cv);
static nxt_http_route_table_t *nxt_http_route_table_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *table_cv,
                                                           nxt_http_route_object_t object, nxt_bool_t case_sensitive,
                                                           nxt_http_uri_encoding_t encoding);
static nxt_http_route_ruleset_t *nxt_http_route_ruleset_create(nxt_task_t *task, nxt_mp_t *mp,
                                                               nxt_conf_value_t *ruleset_cv,
                                                               nxt_http_route_object_t object,
                                                               nxt_bool_t case_sensitive,
                                                               nxt_http_uri_encoding_t encoding);
static nxt_http_route_rule_t *nxt_http_route_rule_name_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *rule_cv,
                                                              nxt_str_t *name, nxt_bool_t case_sensitive,
                                                              nxt_http_uri_encoding_t encoding);
static nxt_http_route_rule_t *nxt_http_route_rule_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *cv,
                                                         nxt_bool_t case_sensitive,
...
static nxt_int_t nxt_http_route_pattern_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *cv,
                                               nxt_http_route_pattern_t *pattern,
                                               nxt_http_route_pattern_case_t pattern_case,
                                               nxt_http_uri_encoding_t encoding);
static nxt_int_t nxt_http_route_decode_str(nxt_str_t *str, nxt_http_uri_encoding_t encoding);
static nxt_int_t nxt_http_route_pattern_slice(nxt_array_t *slices, nxt_str_t *test, nxt_http_route_pattern_type_t type,
                                              nxt_http_uri_encoding_t encoding,
                                              nxt_http_route_pattern_case_t pattern_case);

static nxt_int_t nxt_http_route_resolve(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_http_route_t *route);
static nxt_int_t nxt_http_action_resolve(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_http_action_t *action);
static nxt_http_action_t *nxt_http_pass_var(nxt_task_t *task, nxt_http_request_t *r, nxt_http_action_t *action);
static void nxt_http_pass_query(nxt_task_t *task, nxt_http_request_t *r, nxt_http_action_t *action);
static nxt_int_t nxt_http_pass_find(nxt_mp_t *mp, nxt_router_conf_t *rtcf, nxt_str_t *pass, nxt_http_action_t *action);
static nxt_int_t nxt_http_route_find(nxt_http_routes_t *routes, nxt_str_t *name, nxt_http_action_t *action);

static nxt_http_action_t *nxt_http_route_handler(nxt_task_t *task, nxt_http_request_t *r, nxt_http_action_t *start);
static nxt_http_action_t *nxt_http_route_match(nxt_task_t *task, nxt_http_request_t *r, nxt_http_route_match_t *match);
static nxt_int_t nxt_http_route_table(nxt_http_request_t *r, nxt_http_route_table_t *table);
static nxt_int_t nxt_http_route_ruleset(nxt_http_request_t *r, nxt_http_route_ruleset_t *ruleset);
static nxt_int_t nxt_http_route_rule(nxt_http_request_t *r, nxt_http_route_rule_t *rule);
static nxt_int_t nxt_http_route_header(nxt_http_request_t *r, nxt_http_route_rule_t *rule);
static nxt_int_t nxt_http_route_arguments(nxt_http_request_t *r, nxt_http_route_rule_t *rule);
static nxt_int_t nxt_http_route_test_argument(nxt_http_request_t *r, nxt_http_route_rule_t *rule, nxt_array_t *array);
static nxt_int_t nxt_http_route_scheme(nxt_http_request_t *r, nxt_http_route_rule_t *rule);
static nxt_int_t nxt_http_route_query(nxt_http_request_t *r, nxt_http_route_rule_t *rule);
static nxt_int_t nxt_http_route_cookies(nxt_http_request_t *r, nxt_http_route_rule_t *rule);
static nxt_int_t nxt_http_route_test_cookie(nxt_http_request_t *r, nxt_http_route_rule_t *rule, nxt_array_t *array);
static nxt_int_t nxt_http_route_pattern(nxt_http_request_t *r, nxt_http_route_pattern_t *pattern, u_char *start,
                                        size_t length);
static nxt_int_t nxt_http_route_memcmp(u_char *start, u_char *test, size_t length, nxt_bool_t case_sensitive);

nxt_http_routes_t *nxt_http_routes_create(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_conf_value_t *routes_conf)
{
    size_t size;
    uint32_t i, n, next;
    nxt_mp_t *mp;
...
static nxt_conf_map_t nxt_http_route_match_conf[] = {
    {nxt_string("scheme"), NXT_CONF_MAP_PTR, offsetof(nxt_http_route_match_conf_t, scheme)},
    {
        nxt_string("host"),
        NXT_CONF_MAP_PTR,
                                                           ...
                                                           nxt_conf_value_t *cv)
{
    ...
    ret = nxt_conf_map_object(tmcf->mem_pool, match_conf, nxt_http_route_match_conf,
    ...
    if (mtcf.scheme != NULL)
    {
        rule = nxt_http_route_rule_create(task, mp, mtcf.scheme, 1, NXT_HTTP_ROUTE_PATTERN_NOCASE,
    ...
    if (mtcf.host != NULL)
    {
        rule = nxt_http_route_rule_create(task, mp, mtcf.host, 1, NXT_HTTP_ROUTE_PATTERN_LOWCASE,
                                          NXT_HTTP_URI_ENCODING_NONE);
        if (rule == NULL)
        {
            return NULL;
    ...
    if (mtcf.uri != NULL)
    {
        rule = nxt_http_route_rule_create(task, mp, mtcf.uri, 1, NXT_HTTP_ROUTE_PATTERN_NOCASE, NXT_HTTP_URI_ENCODING);
        if (rule == NULL)
        {
            return NULL;
        }
    ...
    if (mtcf.method != NULL)
    {
        rule = nxt_http_route_rule_create(task, mp, mtcf.method, 1, NXT_HTTP_ROUTE_PATTERN_UPCASE,
                                          NXT_HTTP_URI_ENCODING_NONE);
        if (rule == NULL)
        {
            return NULL;
    ...
    {
        table =
            nxt_http_route_table_create(task, mp, mtcf.headers, NXT_HTTP_ROUTE_HEADER, 0, NXT_HTTP_URI_ENCODING_NONE);
        if (table == NULL)
        {
            return NULL;
        }
    ...
    {
        table = nxt_http_route_table_create(task, mp, mtcf.arguments, NXT_HTTP_ROUTE_ARGUMENT, 1,
    ...
    {
        table =
            nxt_http_route_table_create(task, mp, mtcf.cookies, NXT_HTTP_ROUTE_COOKIE, 1, NXT_HTTP_URI_ENCODING_NONE);
        if (table == NULL)
        {
            return NULL;
        }
    ...
    if (mtcf.query != NULL)
    {
        rule = nxt_http_route_rule_create(task, mp, mtcf.query, 1, NXT_HTTP_ROUTE_PATTERN_NOCASE,
                                          NXT_HTTP_URI_ENCODING_PLUS);
        if (rule == NULL)
        {
            return NULL;
...
static nxt_conf_map_t nxt_http_route_action_conf[] = {
    {nxt_string("rewrite"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, rewrite)},
    {nxt_string("response_headers"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, set_headers)},
    {nxt_string("pass"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, pass)},
    {nxt_string("return"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, ret)},
    {nxt_string("location"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, location)},
    {nxt_string("proxy"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, proxy)},
    {nxt_string("share"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, share)},
    {nxt_string("index"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, index)},
    {nxt_string("chroot"), NXT_CONF_MAP_STR, offsetof(nxt_http_action_conf_t, chroot)},
    {nxt_string("follow_symlinks"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, follow_symlinks)},
    {nxt_string("traverse_mounts"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, traverse_mounts)},
    {nxt_string("types"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, types)},
    {nxt_string("fallback"), NXT_CONF_MAP_PTR, offsetof(nxt_http_action_conf_t, fallback)},
};

nxt_int_t nxt_http_action_init(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_conf_value_t *cv,
                               nxt_http_action_t *action)
{
    nxt_mp_t *mp;
    nxt_int_t ret;
    ...
    ret = nxt_conf_map_object(tmcf->mem_pool, cv, nxt_http_route_action_conf, nxt_nitems(nxt_http_route_action_conf),
                              &acf);
    if (ret != NXT_OK)
    {
        return ret;
                                                           ...
                                                           nxt_http_uri_encoding_t encoding)
{
    ...
    size = sizeof(nxt_http_route_table_t) + n * sizeof(nxt_http_route_ruleset_t *);
    ...
    for (i = 0; i < n; i++)
    {
        ...
        ruleset = nxt_http_route_ruleset_create(task, mp, ruleset_cv, object, case_sensitive, encoding);
                                                               ...
                                                               nxt_http_uri_encoding_t encoding)
{
    ...
    size = sizeof(nxt_http_route_ruleset_t) + n * sizeof(nxt_http_route_rule_t *);
    ...
    for (i = 0; i < n; i++)
    {
        ...
        rule = nxt_http_route_rule_name_create(task, mp, rule_cv, &name, case_sensitive, encoding);
                                                              ...
                                                              nxt_http_uri_encoding_t encoding)
{
    ...
    rule = nxt_http_route_rule_create(task, mp, rule_cv, case_sensitive, NXT_HTTP_ROUTE_PATTERN_NOCASE, encoding);
    if (nxt_slow_path(rule == NULL))
    {
        return NULL;
    }
                                                         ...
                                                         nxt_http_uri_encoding_t encoding)
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        ret = nxt_http_route_pattern_create(task, mp, value, &pattern[i], pattern_case, encoding);
        if (nxt_slow_path(ret != NXT_OK))
        {
            return NULL;
        }
...
nxt_http_route_addr_rule_t *nxt_http_route_addr_rule_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *cv)
{
    size_t size;
    uint32_t i, n;
    nxt_conf_value_t *value;
    ...
    if (n > 1)
    {
        nxt_qsort(addr_rule->addr_pattern, addr_rule->items, sizeof(nxt_http_route_addr_pattern_t),
...
nxt_http_route_rule_t *nxt_http_route_types_rule_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *types)
{
    return nxt_http_route_rule_create(task, mp, types, 0, NXT_HTTP_ROUTE_PATTERN_LOWCASE, NXT_HTTP_URI_ENCODING_NONE);
}
                                               ...
                                               nxt_http_uri_encoding_t encoding)
{
    ...
    if (test.length > 0 && test.start[0] == '~')
    {
        ...
        if (nxt_slow_path(re == NULL))
        {
            ...
            {
                nxt_alert(task, "nxt_regex_compile(%V) failed: %s at offset %d", &test, err.msg, (int)err.offset);
                return NXT_ERROR;
            }
    ...
    if (type == NXT_HTTP_ROUTE_PATTERN_EXACT)
    {
        ...
        ret = nxt_http_route_pattern_slice(slices, &tmp, type, encoding, pattern_case);
        if (nxt_slow_path(ret != NXT_OK))
        {
            return ret;
        }
    ...
    if (test.length != 0 && end[-1] != '*')
    {
        ...
        ret = nxt_http_route_pattern_slice(slices, &tmp, NXT_HTTP_ROUTE_PATTERN_END, encoding, pattern_case);
        if (nxt_slow_path(ret != NXT_OK))
        {
            return ret;
        }
    ...
    while (p != end)
    {
        ...
        ret = nxt_http_route_pattern_slice(slices, &tmp, NXT_HTTP_ROUTE_PATTERN_SUBSTRING, encoding, pattern_case);
        if (nxt_slow_path(ret != NXT_OK))
        {
            return ret;
        }
...
nxt_int_t nxt_http_routes_resolve(nxt_task_t *task, nxt_router_temp_conf_t *tmcf)
{
    nxt_int_t ret;
...
static nxt_int_t nxt_http_action_resolve(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_http_action_t *action)
{
    ...
    if (nxt_tstr_is_const(action->u.tstr))
    {
        ...
        ret = nxt_http_pass_find(tmcf->mem_pool, tmcf->router_conf, &pass, action);
        if (nxt_slow_path(ret != NXT_OK))
        {
            return NXT_ERROR;
        }
...
static nxt_http_action_t *nxt_http_pass_var(nxt_task_t *task, nxt_http_request_t *r, nxt_http_action_t *action)
{
    ...
    ret = nxt_tstr_query_init(&r->tstr_query, rtcf->tstr_state, &r->tstr_cache, r, r->mem_pool);
    if (nxt_slow_path(ret != NXT_OK))
    {
        goto fail;
    }

    action = nxt_mp_zget(r->mem_pool, sizeof(nxt_http_action_t) + sizeof(nxt_str_t));
...
static void nxt_http_pass_query(nxt_task_t *task, nxt_http_request_t *r, nxt_http_action_t *action)
{
    ...
    if (ret != NXT_OK)
    {
        status = (ret == NXT_DECLINED) ? NXT_HTTP_NOT_FOUND : NXT_HTTP_INTERNAL_SERVER_ERROR;
...
static nxt_int_t nxt_http_pass_find(nxt_mp_t *mp, nxt_router_conf_t *rtcf, nxt_str_t *pass, nxt_http_action_t *action)
{
    ...
    {
        return nxt_router_application_init(rtcf, &segments[1], &segments[2], action);
    }
...
nxt_int_t nxt_http_pass_segments(nxt_mp_t *mp, nxt_str_t *pass, nxt_str_t *segments, nxt_uint_t n)
{
    u_char *p;
    nxt_str_t rest;
...
nxt_http_action_t *nxt_http_action_create(nxt_task_t *task, nxt_router_temp_conf_t *tmcf, nxt_str_t *pass)
{
    nxt_mp_t *mp;
    nxt_int_t ret;
    nxt_router_conf_t *rtcf;
...
nxt_http_action_t *nxt_http_pass_application(nxt_task_t *task, nxt_router_conf_t *rtcf, nxt_str_t *name)
{
    nxt_http_action_t *action;
...
static nxt_int_t nxt_http_route_addr_pattern_match(nxt_http_route_addr_pattern_t *p, nxt_sockaddr_t *sa)
{
#if (NXT_INET6)
    uint32_t i;
#endif
    ...
    case AF_INET:
        ...
        match = (base->addr_family == AF_INET || base->addr_family == AF_UNSPEC);
        if (!match)
        {
            break;
        }
        ...
        case NXT_HTTP_ROUTE_ADDR_EXACT:
            match = (memcmp(&sin->sin_addr, &p->addr.v4.start, sizeof(struct in_addr)) == 0);
            break;

        case NXT_HTTP_ROUTE_ADDR_RANGE:
            match = (memcmp(&sin->sin_addr, &p->addr.v4.start, sizeof(struct in_addr)) >= 0 &&
                     memcmp(&sin->sin_addr, &p->addr.v4.end, sizeof(struct in_addr)) <= 0);
            break;

        case NXT_HTTP_ROUTE_ADDR_CIDR:
            match = ((sin->sin_addr.s_addr & p->addr.v4.end) == p->addr.v4.start);
            break;
    ...
    case AF_INET6:
        ...
        match = (base->addr_family == AF_INET6 || base->addr_family == AF_UNSPEC);
        if (!match)
        {
            break;
        }
        ...
        case NXT_HTTP_ROUTE_ADDR_EXACT:
            match = (memcmp(&sin6->sin6_addr, &p->addr.v6.start, sizeof(struct in6_addr)) == 0);
            break;

        case NXT_HTTP_ROUTE_ADDR_RANGE:
            match = (memcmp(&sin6->sin6_addr, &p->addr.v6.start, sizeof(struct in6_addr)) >= 0 &&
                     memcmp(&sin6->sin6_addr, &p->addr.v6.end, sizeof(struct in6_addr)) <= 0);
            break;

        case NXT_HTTP_ROUTE_ADDR_CIDR:
            for (i = 0; i < 16; i++)
            {
                match = ((sin6->sin6_addr.s6_addr[i] & p->addr.v6.end.s6_addr[i]) == p->addr.v6.start.s6_addr[i]);
...
nxt_int_t nxt_http_route_addr_rule(nxt_http_request_t *r, nxt_http_route_addr_rule_t *addr_rule, nxt_sockaddr_t *sa)
{
    uint32_t n;
    nxt_bool_t matches;
...
static nxt_int_t nxt_http_route_header(nxt_http_request_t *r, nxt_http_route_rule_t *rule)
{
    ...
    nxt_list_each(f, r->fields)
    {
        ...
        if (rule->u.name.hash != f->hash || rule->u.name.length != f->name_length ||
            nxt_strncasecmp(rule->u.name.start, f->name, f->name_length) != 0)
        {
            continue;
        }
...
static nxt_int_t nxt_http_route_test_argument(nxt_http_request_t *r, nxt_http_route_rule_t *rule, nxt_array_t *array)
{
    ...
    while (nv < end)
    {
        ...
        if (rule->u.name.hash == nv->hash && rule->u.name.length == nv->name_length &&
            memcmp(rule->u.name.start, nv->name, nv->name_length) == 0)
        {
            ret = nxt_http_route_test_rule(r, rule, nv->value, nv->value_length);
            if (nxt_slow_path(ret == NXT_ERROR))
            {
                return NXT_ERROR;
            }
...
static nxt_int_t nxt_http_route_query(nxt_http_request_t *r, nxt_http_route_rule_t *rule)
{
    ...
    return nxt_http_route_test_rule(r, rule, r->args_decoded.start, r->args_decoded.length);
}
...
nxt_int_t nxt_http_route_test_rule(nxt_http_request_t *r, nxt_http_route_rule_t *rule, u_char *start, size_t length)
{
    nxt_int_t ret;
    ...
    for (i = 0; i < pattern_slices->nelts; i++, pattern_slice++)
    {
        ...
        case NXT_HTTP_ROUTE_PATTERN_EXACT:
            return ((length == pattern->min_length) &&
                    nxt_http_route_memcmp(start, test, test_length, pattern->case_sensitive));

        case NXT_HTTP_ROUTE_PATTERN_BEGIN:
            if (nxt_http_route_memcmp(start, test, test_length, pattern->case_sensitive))
            {
                start += test_length;
                break;
            }
        ...
        case NXT_HTTP_ROUTE_PATTERN_END:
            ...
            if (nxt_http_route_memcmp(p, test, test_length, pattern->case_sensitive))
            {
                end = p;
                break;
            }
...
static nxt_int_t nxt_http_route_memcmp(u_char *start, u_char *test, size_t test_length, nxt_bool_t case_sensitive)
{
    nxt_int_t n;
