...
static nxt_http_route_table_t *nxt_http_route_table_create(
    nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *table_cv,
...
static nxt_http_route_ruleset_t *nxt_http_route_ruleset_create(
    nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *ruleset_cv,
    nxt_http_route_object_t object, nxt_bool_t case_sensitive,
    nxt_http_uri_encoding_t encoding);
...
nxt_http_route_rule_create(nxt_task_t *task, nxt_mp_t *mp, nxt_conf_value_t *cv,
...
static nxt_int_t nxt_http_route_decode_str(nxt_str_t *str,
                                           nxt_http_uri_encoding_t encoding);
static nxt_int_t
nxt_http_route_pattern_slice(nxt_array_t *slices, nxt_str_t *test,
...
static nxt_http_route_table_t *nxt_http_route_table_create(
  ...
  size =
      sizeof(nxt_http_route_table_t) + n * sizeof(nxt_http_route_ruleset_t *);
...
nxt_int_t nxt_http_route_test_rule(nxt_http_request_t *r,
                                   nxt_http_route_rule_t *rule, u_char *start,
                                   size_t length) {
  nxt_int_t ret;
