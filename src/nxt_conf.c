...
static u_char* nxt_conf_json_parse_number(nxt_mp_t* mp,
                                          ...
                                          u_char* end,
                                          nxt_conf_json_error_t* error);
static void nxt_conf_json_parse_error(nxt_conf_json_error_t* error,
                                      u_char* pos,
                                      const char* detail);

static nxt_int_t nxt_conf_copy_value(nxt_mp_t* mp,
                                     const nxt_conf_op_t* op,
                                     nxt_conf_value_t* dst,
                                     const nxt_conf_value_t* src);
static nxt_int_t nxt_conf_copy_array(nxt_mp_t* mp,
                                     const nxt_conf_op_t* op,
                                     nxt_conf_value_t* dst,
                                     const nxt_conf_value_t* src);
static nxt_int_t nxt_conf_copy_object(nxt_mp_t* mp,
                                      const nxt_conf_op_t* op,
                                      nxt_conf_value_t* dst,
                                      const nxt_conf_value_t* src);
...
nxt_str_t* nxt_conf_get_string_dup(const nxt_conf_value_t* value,
                                   nxt_mp_t* mp,
                                   nxt_str_t* str) {
  nxt_str_t s;
...
nxt_int_t nxt_conf_set_string_dup(nxt_conf_value_t* value,
                                  nxt_mp_t* mp,
                                  const nxt_str_t* str) {
  nxt_str_t tmp, *ptr;
...
nxt_conf_value_t* nxt_conf_create_object(nxt_mp_t* mp, nxt_uint_t count) {
  ...
  size = sizeof(nxt_conf_value_t) + sizeof(nxt_conf_object_t) +
...
void nxt_conf_set_member(nxt_conf_value_t* object,
...
nxt_int_t nxt_conf_set_member_dup(nxt_conf_value_t* object,
                                  nxt_mp_t* mp,
                                  const nxt_str_t* name,
                                  const nxt_conf_value_t* value,
                                  uint32_t index) {
...
void nxt_conf_set_member_null(nxt_conf_value_t* object,
                              const nxt_str_t* name,
                              uint32_t index) {
  nxt_conf_object_member_t* member;
...
nxt_conf_value_t* nxt_conf_create_array(nxt_mp_t* mp, nxt_uint_t count) {
  ...
  size = sizeof(nxt_conf_value_t) + sizeof(nxt_conf_array_t) +
...
void nxt_conf_set_element(nxt_conf_value_t* array,
                          nxt_uint_t index,
                          const nxt_conf_value_t* value) {
...
nxt_conf_value_t* nxt_conf_get_path(nxt_conf_value_t* value,
...
nxt_conf_value_t* nxt_conf_get_object_member(const nxt_conf_value_t* value,
                                             const nxt_str_t* name,
                                             uint32_t* index) {
  nxt_str_t str;
  nxt_uint_t n;
...
nxt_int_t nxt_conf_map_object(nxt_mp_t* mp,
                              const nxt_conf_value_t* value,
                              const nxt_conf_map_t* map,
                              nxt_uint_t n,
                              void* data) {
  double num;
  nxt_str_t str, *s;
...
nxt_conf_value_t* nxt_conf_next_object_member(const nxt_conf_value_t* value,
                                              nxt_str_t* name,
                                              uint32_t* next) {
  uint32_t n;
  nxt_conf_object_t* object;
...
nxt_conf_value_t* nxt_conf_get_array_element(const nxt_conf_value_t* value,
                                             uint32_t index) {
  nxt_conf_array_t* array;
...
nxt_conf_value_t* nxt_conf_get_array_element_or_itself(nxt_conf_value_t* value,
                                                       uint32_t index) {
  nxt_conf_array_t* array;
...
nxt_conf_op_ret_t nxt_conf_op_compile(nxt_mp_t* mp,
                                      nxt_conf_op_t** ops,
                                      const nxt_conf_value_t* root,
                                      const nxt_str_t* path,
                                      nxt_conf_value_t* value,
                                      nxt_bool_t add) {
  nxt_str_t token;
...
nxt_conf_value_t* nxt_conf_clone(nxt_mp_t* mp,
                                 nxt_conf_op_t* op,
                                 const nxt_conf_value_t* value) {
  nxt_int_t rc;
...
static nxt_int_t nxt_conf_copy_value(nxt_mp_t* mp,
                                     ...
                                     nxt_conf_value_t* dst,
                                     const nxt_conf_value_t* src) {
  if (op != NULL && src->type != NXT_CONF_VALUE_ARRAY &&
...
static nxt_int_t nxt_conf_copy_object(nxt_mp_t* mp,
  ...
  do {
    ...
    while (s != index) {
      rc = nxt_conf_copy_value(mp, NULL, &dst->u.object->members[d].name,
      ...
      rc = nxt_conf_copy_value(mp, pass_op, &dst->u.object->members[d].value,
...
nxt_conf_value_t* nxt_conf_json_parse(nxt_mp_t* mp,
                                      u_char* start,
                                      u_char* end,
                                      nxt_conf_json_error_t* error) {
  u_char* p;
  ...
  if (nxt_slow_path(p != end)) {
    nxt_conf_json_parse_error(
        error, p, "Unexpected character after the end of a valid JSON value.");
...
static u_char* nxt_conf_json_parse_object(nxt_mp_t* mp,
  ...
  object = nxt_mp_get(
      mp, sizeof(nxt_conf_object_t) + count * sizeof(nxt_conf_object_member_t));
...
static u_char* nxt_conf_json_parse_array(nxt_mp_t* mp,
  ...
  array = nxt_mp_get(
      mp, sizeof(nxt_conf_array_t) + count * sizeof(nxt_conf_value_t));
...
static u_char* nxt_conf_json_parse_number(nxt_mp_t* mp,
  ...
  value->type =
      (num == trunc(num)) ? NXT_CONF_VALUE_INTEGER : NXT_CONF_VALUE_NUMBER;
...
u_char* nxt_conf_json_print(u_char* p,
                            const nxt_conf_value_t* value,
                            nxt_conf_json_pretty_t* pretty) {
  switch (value->type) {
    case NXT_CONF_VALUE_NULL:
...
void nxt_conf_json_position(u_char* start,
                            const u_char* pos,
                            nxt_uint_t* line,
                            nxt_uint_t* column) {
  u_char* p;
