...
nxt_conf_set_member_dup (nxt_conf_value_t *object, nxt_mp_t *mp,
                         const nxt_str_t *name, const nxt_conf_value_t *value,
                         uint32_t index)
{
  nxt_conf_object_member_t *member;
...
nxt_conf_set_member_string_dup (nxt_conf_value_t *object, nxt_mp_t *mp,
                                const nxt_str_t *name, const nxt_str_t *value,
                                uint32_t index)
{
  nxt_conf_object_member_t *member;
...
nxt_conf_value_t *
nxt_conf_get_object_member (const nxt_conf_value_t *value,
                            const nxt_str_t *name, uint32_t *index)
{
  nxt_str_t str;
  nxt_uint_t n;
  nxt_conf_object_t *object;
                      ...
                      int (*compare) (const void *, const void *))
{
  ...
  nxt_qsort (array->elements, array->count, sizeof (nxt_conf_value_t),
             compare);
}
                      ...
                      nxt_conf_value_t *dst, const nxt_conf_value_t *src)
{
  ...
  size
      = sizeof (nxt_conf_object_t) + count * sizeof (nxt_conf_object_member_t);
      ...
      if (op != NULL)
        {
          switch (op->action)
            ...
            case NXT_CONF_OP_CREATE:
              ...
              rc = nxt_conf_copy_value (
                  mp, NULL, &dst->u.object->members[d].name, &member->name);
...
static u_char *
nxt_conf_json_parse_value (nxt_mp_t *mp, nxt_conf_value_t *value,
                           u_char *start, u_char *end,
                           nxt_conf_json_error_t *error)
{
  u_char ch, *p;
...
static u_char *
nxt_conf_json_parse_object (nxt_mp_t *mp, nxt_conf_value_t *value,
                            u_char *start, u_char *end,
                            nxt_conf_json_error_t *error)
{
  u_char *p, *name;
...
static u_char *
nxt_conf_json_parse_array (nxt_mp_t *mp, nxt_conf_value_t *value,
                           u_char *start, u_char *end,
                           nxt_conf_json_error_t *error)
{
  u_char *p;
...
static u_char *
nxt_conf_json_parse_string (nxt_mp_t *mp, nxt_conf_value_t *value,
                            u_char *start, u_char *end,
                            nxt_conf_json_error_t *error)
{
  u_char *p, ch, *last, *s;
...
static u_char *
nxt_conf_json_parse_number (nxt_mp_t *mp, nxt_conf_value_t *value,
                            u_char *start, u_char *end,
                            nxt_conf_json_error_t *error)
{
