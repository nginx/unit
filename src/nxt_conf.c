...
static nxt_int_t nxt_conf_path_next_token(nxt_conf_path_parse_t *parse, nxt_str_t *token);

static u_char *nxt_conf_json_skip_space(u_char *start, const u_char *end);
static u_char *nxt_conf_json_parse_value(nxt_mp_t *mp, nxt_conf_value_t *value, u_char *start, u_char *end,
                                         nxt_conf_json_error_t *error);
static u_char *nxt_conf_json_parse_object(nxt_mp_t *mp, nxt_conf_value_t *value, u_char *start, u_char *end,
                                          nxt_conf_json_error_t *error);
static nxt_int_t nxt_conf_object_hash_add(nxt_mp_t *mp, nxt_lvlhsh_t *lvlhsh, nxt_conf_object_member_t *member);
static nxt_int_t nxt_conf_object_hash_test(nxt_lvlhsh_query_t *lhq, void *data);
static void *nxt_conf_object_hash_alloc(void *data, size_t size);
static void nxt_conf_object_hash_free(void *data, void *p);
static u_char *nxt_conf_json_parse_array(nxt_mp_t *mp, nxt_conf_value_t *value, u_char *start, u_char *end,
                                         nxt_conf_json_error_t *error);
static u_char *nxt_conf_json_parse_string(nxt_mp_t *mp, nxt_conf_value_t *value, u_char *start, u_char *end,
                                          nxt_conf_json_error_t *error);
static u_char *nxt_conf_json_parse_number(nxt_mp_t *mp, nxt_conf_value_t *value, u_char *start, u_char *end,
                                          nxt_conf_json_error_t *error);
static void nxt_conf_json_parse_error(nxt_conf_json_error_t *error, u_char *pos, const char *detail);

static nxt_int_t nxt_conf_copy_value(nxt_mp_t *mp, const nxt_conf_op_t *op, nxt_conf_value_t *dst,
                                     const nxt_conf_value_t *src);
static nxt_int_t nxt_conf_copy_array(nxt_mp_t *mp, const nxt_conf_op_t *op, nxt_conf_value_t *dst,
                                     const nxt_conf_value_t *src);
static nxt_int_t nxt_conf_copy_object(nxt_mp_t *mp, const nxt_conf_op_t *op, nxt_conf_value_t *dst,
                                      const nxt_conf_value_t *src);

static size_t nxt_conf_json_string_length(const nxt_conf_value_t *value);
static u_char *nxt_conf_json_print_string(u_char *p, const nxt_conf_value_t *value);
static size_t nxt_conf_json_array_length(const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty);
static u_char *nxt_conf_json_print_array(u_char *p, const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty);
static size_t nxt_conf_json_object_length(const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty);
static u_char *nxt_conf_json_print_object(u_char *p, const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty);
...
#define nxt_conf_json_newline(p) ((p)[0] = '\r', (p)[1] = '\n', (p) + 2)

nxt_inline u_char *nxt_conf_json_indentation(u_char *p, uint32_t level)
{
    while (level)
    {
        *p++ = '\t';
...
void nxt_conf_get_string(const nxt_conf_value_t *value, nxt_str_t *str)
{
...
nxt_str_t *nxt_conf_get_string_dup(const nxt_conf_value_t *value, nxt_mp_t *mp, nxt_str_t *str)
{
    nxt_str_t s;
...
void nxt_conf_set_string(nxt_conf_value_t *value, const nxt_str_t *str)
{
...
nxt_int_t nxt_conf_set_string_dup(nxt_conf_value_t *value, nxt_mp_t *mp, const nxt_str_t *str)
{
    nxt_str_t tmp, *ptr;
...
double nxt_conf_get_number(nxt_conf_value_t *value)
{
    return nxt_strtod(value->u.number, NULL);
}

uint8_t nxt_conf_get_boolean(nxt_conf_value_t *value)
{
    return value->u.boolean;
}

nxt_uint_t nxt_conf_object_members_count(const nxt_conf_value_t *value)
{
...
nxt_conf_value_t *nxt_conf_create_object(nxt_mp_t *mp, nxt_uint_t count)
{
    ...
    size = sizeof(nxt_conf_value_t) + sizeof(nxt_conf_object_t) + count * sizeof(nxt_conf_object_member_t);
...
void nxt_conf_set_member(nxt_conf_value_t *object, const nxt_str_t *name, const nxt_conf_value_t *value, uint32_t index)
{
...
nxt_int_t nxt_conf_set_member_dup(nxt_conf_value_t *object, nxt_mp_t *mp, const nxt_str_t *name,
...
void nxt_conf_set_member_string(nxt_conf_value_t *object, const nxt_str_t *name, const nxt_str_t *value, uint32_t index)
{
    nxt_conf_object_member_t *member;
...
nxt_int_t nxt_conf_set_member_string_dup(nxt_conf_value_t *object, nxt_mp_t *mp, const nxt_str_t *name,
...
void nxt_conf_set_member_integer(nxt_conf_value_t *object, const nxt_str_t *name, int64_t value, uint32_t index)
{
    u_char *p, *end;
    nxt_conf_object_member_t *member;
...
void nxt_conf_set_member_null(nxt_conf_value_t *object, const nxt_str_t *name, uint32_t index)
{
    nxt_conf_object_member_t *member;
...
nxt_conf_value_t *nxt_conf_create_array(nxt_mp_t *mp, nxt_uint_t count)
{
    ...
    size = sizeof(nxt_conf_value_t) + sizeof(nxt_conf_array_t) + count * sizeof(nxt_conf_value_t);
...
void nxt_conf_set_element(nxt_conf_value_t *array, nxt_uint_t index, const nxt_conf_value_t *value)
{
    array->u.array->elements[index] = *value;
}

nxt_int_t nxt_conf_set_element_string_dup(nxt_conf_value_t *array, nxt_mp_t *mp, nxt_uint_t index,
                                          const nxt_str_t *value)
{
...
nxt_uint_t nxt_conf_array_elements_count(const nxt_conf_value_t *value)
{
    return value->u.array->count;
}

nxt_uint_t nxt_conf_array_elements_count_or_1(const nxt_conf_value_t *value)
{
    return (value->type == NXT_CONF_VALUE_ARRAY) ? value->u.array->count : 1;
}

nxt_uint_t nxt_conf_type(const nxt_conf_value_t *value)
{
    switch (value->type)
    {
...
nxt_conf_value_t *nxt_conf_get_path(nxt_conf_value_t *value, const nxt_str_t *path)
{
    nxt_str_t token;
    nxt_int_t ret, index;
...
nxt_conf_value_t *nxt_conf_get_object_member(const nxt_conf_value_t *value, const nxt_str_t *name, uint32_t *index)
{
    nxt_str_t str;
    nxt_uint_t n;
    nxt_conf_object_t *object;
...
nxt_int_t nxt_conf_map_object(nxt_mp_t *mp, const nxt_conf_value_t *value, const nxt_conf_map_t *map, nxt_uint_t n,
                              void *data)
{
    double num;
    nxt_str_t str, *s;
    ...
    for (i = 0; i < n; i++)
    {
        ...
        case NXT_CONF_MAP_CSTRZ:
            ...
            if (v->type != NXT_CONF_VALUE_SHORT_STRING && v->type != NXT_CONF_VALUE_STRING)
            {
                break;
            }
...
nxt_conf_value_t *nxt_conf_next_object_member(const nxt_conf_value_t *value, nxt_str_t *name, uint32_t *next)
{
    uint32_t n;
    nxt_conf_object_t *object;
    nxt_conf_object_member_t *member;
...
nxt_conf_value_t *nxt_conf_get_array_element(const nxt_conf_value_t *value, uint32_t index)
{
    nxt_conf_array_t *array;
...
nxt_conf_value_t *nxt_conf_get_array_element_or_itself(nxt_conf_value_t *value, uint32_t index)
{
    nxt_conf_array_t *array;
...
void nxt_conf_array_qsort(const nxt_conf_value_t *value, int (*compare)(const void *, const void *))
{
    nxt_conf_array_t *array;
...
nxt_conf_op_ret_t nxt_conf_op_compile(nxt_mp_t *mp, nxt_conf_op_t **ops, const nxt_conf_value_t *root,
                                      const nxt_str_t *path, nxt_conf_value_t *value, nxt_bool_t add)
{
    nxt_str_t token;
    nxt_int_t ret, index;
...
nxt_conf_value_t *nxt_conf_clone(nxt_mp_t *mp, nxt_conf_op_t *op, const nxt_conf_value_t *value)
{
    nxt_int_t rc;
...
static nxt_int_t nxt_conf_copy_value(nxt_mp_t *mp, const nxt_conf_op_t *op, nxt_conf_value_t *dst,
                                     const nxt_conf_value_t *src)
{
    if (op != NULL && src->type != NXT_CONF_VALUE_ARRAY && src->type != NXT_CONF_VALUE_OBJECT)
    {
        return NXT_ERROR;
    }
    ...
    case NXT_CONF_VALUE_STRING:
        ...
        nxt_memcpy(dst->u.string.start, src->u.string.start, src->u.string.length);
                                     ...
                                     const nxt_conf_value_t *src)
{
    ...
    do
    {
        ...
        while (s != index)
        {
            rc = nxt_conf_copy_value(mp, pass_op, &dst->u.array->elements[d], &src->u.array->elements[s]);
            if (nxt_slow_path(rc != NXT_OK))
            {
                return NXT_ERROR;
            }
                                      ...
                                      const nxt_conf_value_t *src)
{
    ...
    size = sizeof(nxt_conf_object_t) + count * sizeof(nxt_conf_object_member_t);
    ...
    do
    {
        ...
        while (s != index)
        {
            rc = nxt_conf_copy_value(mp, NULL, &dst->u.object->members[d].name, &src->u.object->members[s].name);
            ...
            rc = nxt_conf_copy_value(mp, pass_op, &dst->u.object->members[d].value, &src->u.object->members[s].value);
        ...
        if (op != NULL)
        {
            ...
            case NXT_CONF_OP_CREATE:
                ...
                rc = nxt_conf_copy_value(mp, NULL, &dst->u.object->members[d].name, &member->name);
...
nxt_conf_value_t *nxt_conf_json_parse(nxt_mp_t *mp, u_char *start, u_char *end, nxt_conf_json_error_t *error)
{
    u_char *p;
    nxt_conf_value_t *value;
    ...
    if (nxt_slow_path(p != end))
    {
        ...
        nxt_conf_json_parse_error(error, p, "Unexpected character after the end of a valid JSON value.");
                                         ...
                                         nxt_conf_json_error_t *error)
{
    ...
    case 't':
        if (nxt_fast_path(end - start >= 4 && memcmp(start, "true", 4) == 0))
        {
            value->u.boolean = 1;
    ...
    case 'f':
        if (nxt_fast_path(end - start >= 5 && memcmp(start, "false", 5) == 0))
        {
            value->u.boolean = 0;
            value->type = NXT_CONF_VALUE_BOOLEAN;
    ...
    case 'n':
        if (nxt_fast_path(end - start >= 4 && memcmp(start, "null", 4) == 0))
        {
...
static const nxt_lvlhsh_proto_t nxt_conf_object_hash_proto nxt_aligned(64) = {
    NXT_LVLHSH_DEFAULT,
                                          ...
                                          nxt_conf_json_error_t *error)
{
    ...
    object = nxt_mp_get(mp, sizeof(nxt_conf_object_t) + count * sizeof(nxt_conf_object_member_t));
                                          ...
                                          nxt_conf_json_error_t *error)
{
    ...
    for (p = start; nxt_fast_path(p != end); p++)
    {
        ...
        case sw_encoded4:
            ...
            if (nxt_fast_path((ch >= '0' && ch <= '9') || (ch >= 'A' && ch <= 'F') || (ch >= 'a' && ch <= 'f')))
            {
    ...
    do
    {
        ...
        for (;;)
        {
            for (i = 0; i < 4; i++)
            {
                utf = (utf << 4) | (p[i] >= 'A' ? 10 + ((p[i] & ~0x20) - 'A') : p[i] - '0');
            }
                                          ...
                                          nxt_conf_json_error_t *error)
{
    ...
    if (nxt_slow_path(nxt_errno == NXT_ERANGE || fabs(num) > (double)NXT_INT64_T_MAX))
    {
        nxt_conf_json_parse_error(error, start,
    ...
    {
        nxt_thread_log_alert("strtod(\"%s\", %s) failed %E", value->u.number, end == NULL ? (u_char *)"NULL" : end,
                             nxt_errno);
        return NULL;
    }

    value->type = (num == trunc(num)) ? NXT_CONF_VALUE_INTEGER : NXT_CONF_VALUE_NUMBER;
...
size_t nxt_conf_json_length(const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty)
{
    switch (value->type)
    {
...
u_char *nxt_conf_json_print(u_char *p, const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty)
{
    switch (value->type)
    {
    ...
    case NXT_CONF_VALUE_BOOLEAN:
        return value->u.boolean ? nxt_cpymem(p, "true", 4) : nxt_cpymem(p, "false", 5);
...
static size_t nxt_conf_json_object_length(const nxt_conf_value_t *value, nxt_conf_json_pretty_t *pretty)
{
    ...
    for (n = 0; n < object->count; n++)
    {
        len += nxt_conf_json_string_length(&member[n].name) + 1 + nxt_conf_json_length(&member[n].value, pretty) + 1;
...
void nxt_conf_json_position(u_char *start, const u_char *pos, nxt_uint_t *line, nxt_uint_t *column)
{
    u_char *p;
    ssize_t symbols;
    nxt_uint_t lines;
